 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxUserRoleRelation4SynchExWApi
 表名:vQxUserRoleRelation4Synch(00140095)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:30
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxUserRoleRelation4SynchExWApi
{
private static readonly string mstrApiControllerName = "vQxUserRoleRelation4SynchExApi";
 /// <summary>
