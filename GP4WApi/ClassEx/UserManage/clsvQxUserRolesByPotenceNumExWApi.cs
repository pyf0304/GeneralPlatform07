 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxUserRolesByPotenceNumExWApi
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxUserRolesByPotenceNumExWApi
{
private static readonly string mstrApiControllerName = "vQxUserRolesByPotenceNumExApi";
 /// <summary>
