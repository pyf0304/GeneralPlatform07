 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxPotenceSymbolForRole
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPotenceSymbolForRole
{
public const string CurrTabName_S = "vQxPotenceSymbolForRole"; //当前表名,与该类相关的表名
