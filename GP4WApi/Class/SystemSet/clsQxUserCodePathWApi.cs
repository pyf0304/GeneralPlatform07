...
/// 静态类
/// </summary>
public static class  clsQxUserCodePathWApi_Static
{
...
try
{
objQxUserCodePathEN.sfUpdFldSetStr = objQxUserCodePathEN.getsfUpdFldSetStr();
clsQxUserCodePathWApi.CheckPropertyNew(objQxUserCodePathEN); 
bool bolResult = clsQxUserCodePathWApi.UpdateRecord(objQxUserCodePathEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxUserCodePathEN objQxUserCodePathEN)
{
//检测记录是否存在
...
{
clsQxUserCodePathWApi.CheckPropertyNew(objQxUserCodePathEN); 
bool bolResult = clsQxUserCodePathWApi.AddNewRecord(objQxUserCodePathEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserCodePathWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
{
clsQxUserCodePathWApi.CheckPropertyNew(objQxUserCodePathEN); 
bool bolResult = clsQxUserCodePathWApi.UpdateWithCondition(objQxUserCodePathEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserCodePathWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxUserCodePathWApi
{
private static readonly string mstrApiControllerName = "QxUserCodePathApi";
...
if (!Object.Equals(null, objQxUserCodePathEN.UpdDate) && GetStrLen(objQxUserCodePathEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objQxUserCodePathEN.UpdUserId) && GetStrLen(objQxUserCodePathEN.UpdUserId) > 20)
{
...
clsQxUserCodePathEN objQxUserCodePathEN;
...
objQxUserCodePathEN = JsonConvert.DeserializeObject<clsQxUserCodePathEN>(strJson);
return objQxUserCodePathEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxUserCodePathEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsQxUserCodePathEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxUserCodePathEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxUserCodePathEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsQxUserCodePathEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxUserCodePathEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxUserCodePathEN> arrObjLst; 
...
try
{
 clsQxUserCodePathEN objQxUserCodePathEN = clsQxUserCodePathWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxUserCodePaths(List<string> arrmId)
{
string strAction = "DelQxUserCodePaths";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelQxUserCodePathsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxUserCodePathEN objQxUserCodePathEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJson = clsJSON.GetJsonFromObj<clsQxUserCodePathEN>(objQxUserCodePathEN);
if (clsPubFun4WApi.Post(mstrApiControllerName, strAction, dictParam, strJson, out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
...
public static string AddNewRecordWithReturnKey(clsQxUserCodePathEN objQxUserCodePathEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxUserCodePathEN objQxUserCodePathEN)
{
if (string.IsNullOrEmpty(objQxUserCodePathEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxUserCodePathEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxUserCodePathEN objQxUserCodePathEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxUserCodePathEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxUserCodePathEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxUserCodePathEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxUserCodePathEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxUserCodePathEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxUserCodePathEN objInFor in arrObj)
{
//Rows
...
if (clsQxUserCodePathWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxUserCodePathEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxUserCodePathWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsQxUserCodePathEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxUserCodePath.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conQxUserCodePath.QxPrjId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.UserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.QxCodeTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.CodePath, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.CodePathBackup, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.IsTemplate, Type.GetType("System.Boolean"));
objDT.Columns.Add(conQxUserCodePath.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.UpdUserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.Memo, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserCodePath.IsGeneReport, Type.GetType("System.Boolean"));
foreach (clsQxUserCodePathEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxUserCodePath.mId] = objInFor[conQxUserCodePath.mId];
objDR[conQxUserCodePath.QxPrjId] = objInFor[conQxUserCodePath.QxPrjId];
objDR[conQxUserCodePath.UserId] = objInFor[conQxUserCodePath.UserId];
objDR[conQxUserCodePath.QxCodeTypeId] = objInFor[conQxUserCodePath.QxCodeTypeId];
objDR[conQxUserCodePath.CodePath] = objInFor[conQxUserCodePath.CodePath];
objDR[conQxUserCodePath.CodePathBackup] = objInFor[conQxUserCodePath.CodePathBackup];
objDR[conQxUserCodePath.IsTemplate] = objInFor[conQxUserCodePath.IsTemplate];
objDR[conQxUserCodePath.UpdDate] = objInFor[conQxUserCodePath.UpdDate];
objDR[conQxUserCodePath.UpdUserId] = objInFor[conQxUserCodePath.UpdUserId];
objDR[conQxUserCodePath.Memo] = objInFor[conQxUserCodePath.Memo];
objDR[conQxUserCodePath.IsGeneReport] = objInFor[conQxUserCodePath.IsGeneReport];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4QxUserCodePath : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserCodePathWApi.ReFreshThisCache();
}
}
