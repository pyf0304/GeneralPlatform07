...
public static string[] AttributeName = new string[] {"mId", "IpAddress", "UserId", "RoleId", "QxPrjId", "UpdDate", "UpdUser", "Memo"};
...
else if (strAttributeName  ==  conQxUserRoleRelation4Synch.UpdUser)
{
return mstrUpdUser;
}
...
mstrUpdUser = value.ToString();
 AddUpdatedFld(conQxUserRoleRelation4Synch.UpdUser);
}
else if (strAttributeName  ==  conQxUserRoleRelation4Synch.Memo)
{
...
else if (conQxUserRoleRelation4Synch.UpdUser  ==  AttributeName[intIndex])
{
return mstrUpdUser;
}
