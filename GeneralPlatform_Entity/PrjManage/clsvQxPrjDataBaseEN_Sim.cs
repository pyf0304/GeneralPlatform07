 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPrjDataBaseEN_Sim
 表名:vQxPrjDataBase
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:39:23
 生成者:潘以锋
...
public class clsvQxPrjDataBaseEN_Sim 
{
//以下是属性变量

private string mstrQxPrjDataBaseId;    //项目数据库Id
private string mstrPrjDataBaseName;    //项目数据库名
private string mstrIpAddress;    //IP地址
private string mstrDataBaseUserId;    //数据库用户Id
private string mstrDataBasePwd;    //数据库用户口令
private string mstrDataBaseName;    //数据库名称
private string mstrDataBaseTypeName;    //数据库类型名
private string mstrDataBaseTypeId;    //数据库类型ID
private string mstrDatabaseOwner;    //数据库拥有者
private string mstrTableSpace;    //表空间
private string mstrUpdDate;    //修改日期
private string mstrSID;    //SID
