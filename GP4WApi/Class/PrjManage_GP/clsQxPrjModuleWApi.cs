...
/// 静态类
/// </summary>
public static class  clsQxPrjModuleWApi_Static
{
...
try
{
objQxPrjModuleEN.sfUpdFldSetStr = objQxPrjModuleEN.getsfUpdFldSetStr();
clsQxPrjModuleWApi.CheckPropertyNew(objQxPrjModuleEN); 
bool bolResult = clsQxPrjModuleWApi.UpdateRecord(objQxPrjModuleEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxPrjModuleEN objQxPrjModuleEN)
{
//检测记录是否存在
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsQxPrjModuleWApi.IsExist(objQxPrjModuleEN.ModuleId) == true)
 {
...
{
clsQxPrjModuleWApi.CheckPropertyNew(objQxPrjModuleEN); 
bool bolResult = clsQxPrjModuleWApi.AddNewRecord(objQxPrjModuleEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPrjModuleWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objQxPrjModuleEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsQxPrjModuleEN objQxPrjModuleEN)
{
try
{
clsQxPrjModuleWApi.CheckPropertyNew(objQxPrjModuleEN); 
string strModuleId = clsQxPrjModuleWApi.AddNewRecordWithMaxId(objQxPrjModuleEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPrjModuleWApi.ReFreshCache();
return strModuleId;
}
...
{
clsQxPrjModuleWApi.CheckPropertyNew(objQxPrjModuleEN); 
bool bolResult = clsQxPrjModuleWApi.UpdateWithCondition(objQxPrjModuleEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPrjModuleWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxPrjModuleWApi
{
private static readonly string mstrApiControllerName = "QxPrjModuleApi";
...
List<clsQxPrjModuleEN> arrObjLst = clsQxPrjModuleWApi.GetObjLst(strCondition);
//初始化一个对象列表
...
clsQxPrjModuleEN objQxPrjModuleEN;
...
objQxPrjModuleEN = JsonConvert.DeserializeObject<clsQxPrjModuleEN>(strJson);
return objQxPrjModuleEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxPrjModuleEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsQxPrjModuleEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxPrjModuleEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxPrjModuleEN> GetObjLstByModuleIdLst(List<string> arrModuleId)
{
 List<clsQxPrjModuleEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxPrjModuleEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxPrjModuleEN> arrObjLst; 
...
try
{
 clsQxPrjModuleEN objQxPrjModuleEN = clsQxPrjModuleWApi.GetObjByModuleId(strModuleId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strModuleId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxPrjModules(List<string> arrModuleId)
{
string strAction = "DelQxPrjModules";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrModuleId);
...
{
string strAction = "DelQxPrjModulesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxPrjModuleEN objQxPrjModuleEN)
{
...
public static string AddNewRecordWithMaxId(clsQxPrjModuleEN objQxPrjModuleEN)
{
...
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
var strModuleId = (string)jobjReturn0["returnStr"];
return strModuleId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxPrjModuleEN objQxPrjModuleEN)
{
if (string.IsNullOrEmpty(objQxPrjModuleEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxPrjModuleEN.ModuleId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxPrjModuleEN objQxPrjModuleEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxPrjModuleEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxPrjModuleEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxPrjModuleEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxPrjModuleEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxPrjModuleEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxPrjModuleEN objInFor in arrObj)
{
//Rows
...
if (clsQxPrjModuleWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxPrjModuleEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxPrjModuleWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsQxPrjModuleEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxPrjModule.ModuleId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjModule.ModuleName, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjModule.QxPrjId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjModule.Memo, Type.GetType("System.String"));
foreach (clsQxPrjModuleEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxPrjModule.ModuleId] = objInFor[conQxPrjModule.ModuleId];
objDR[conQxPrjModule.ModuleName] = objInFor[conQxPrjModule.ModuleName];
objDR[conQxPrjModule.QxPrjId] = objInFor[conQxPrjModule.QxPrjId];
objDR[conQxPrjModule.Memo] = objInFor[conQxPrjModule.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4QxPrjModule : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPrjModuleWApi.ReFreshThisCache();
}
}
