...
namespace GP4WApi
{
public static class clsFuncModuleExWApi_Static
{
...
clsFuncModuleWApi.CopyTo(objFuncModuleENS, objFuncModuleENT);
...
public static bool EditRecordEx(this clsFuncModuleEN objFuncModuleEN)
{
try
{
objFuncModuleEN.sfUpdFldSetStr = objFuncModuleEN.getsfUpdFldSetStr();
bool bolResult = clsFuncModuleExWApi.EditRecordEx(objFuncModuleEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsFuncModuleExWApi
{
        private static readonly string mstrApiControllerName = "FuncModuleExApi";
        /// <summary>
        /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
        /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
        /// </summary>
        public static List<clsFuncModuleEN> arrFuncModuleObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsFuncModuleEN objFuncModuleEN)
{
