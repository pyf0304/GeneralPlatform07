...
namespace GeneralPlatform.Webform
{
    ...
    /// </summary>
    public partial class wfmSetMenu4Roles2 : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                wucTreeView1.QxPrjId = strUserPrjId;
        ...
        private void ShowMenuTreeBak()
        {
            ...
            //1、获取主菜单项
            strCondition.AppendFormat("UpMenuId = '00000000' and QxPrjId = '{0}'",
...
//                        strSubMenuName = objPrjMenu_Sub.MenuName + objPrjMenu_Sub.MenuId + (objPrjMenu_Sub.IsLeafNode ? "(叶子)" : ""); //获取主菜单项NAME
        ...
        private void ShowMenuTreeWithRoleIdBak20140424(string RoleId)
        {
...
//                strUpMenuName = objPrjMenu_Up.MenuName; //获取主菜单项NAME
        ...
        protected void Button1_Click(object sender, System.EventArgs e)
        {
            ...
            {
                strRoleId = wucTreeView1.NodeData.RoleId;
            }
        ...
        protected void btnAddRoleMenu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                clsQxRoleMenusBLEx.RoleAddMenus(this.ddlPrj.SelectedValue, vsRoleId, arrCheckedMenus, clsCommonSession.UserId);
            }
            catch (Exception objException)
            {
                clsCommonJsFunc.Alert(this, objException.Message);
