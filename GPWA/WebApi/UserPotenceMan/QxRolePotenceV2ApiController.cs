 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:QxRolePotenceV2ApiController
 表名:QxRolePotenceV2(00140117)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/22 17:53:49
 生成者:pyf
 生成服务器IP:
 工程名称:统一平台(0014)
...
{
 /// <summary>
 /// QxRolePotenceV2Controller 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  QxRolePotenceV2ApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjByRId?RId=value
...
public ActionResult GetObjByKeyLst(int intRId,int intPId)
{
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxRolePotenceV2EN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLstCache(strQxPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/QxRolePotenceV2api/GetObjLstByRIdLst
...
IEnumerable<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLstByKeyLstsCache(lstKeyLst, QxPrjId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 intRId = clsQxRolePotenceV2BL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 获取当前表满足条件的第一条记录的对象
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsQxRolePotenceV2EN objQxRolePotenceV2EN = clsQxRolePotenceV2BL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objQxRolePotenceV2EN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst;
 try
 {
 arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjLstByPager_Cache?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 IEnumerable<clsQxRolePotenceV2EN> arrQxRolePotenceV2ObjLst;
 try
 {
 arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLstByPagerCache(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 ...
 /// <summary>
 /// 根据条件获取范围内的对象列表
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetObjLstByRange?strOrderBy=v1&intMaxNum=v2&intMinNum=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 arrQxRolePotenceV2ObjLst = clsQxRolePotenceV2BL.GetObjLstByRange(objRangePara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrQxRolePotenceV2ObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsQxRolePotenceV2BL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/QxRolePotenceV2Api/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsQxRolePotenceV2BL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/QxRolePotenceV2Api/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsQxRolePotenceV2BL.SetFldValue(clsQxRolePotenceV2EN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/QxRolePotenceV2Api/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsQxRolePotenceV2BL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/QxRolePotenceV2Api/IsExist?RId=value
 /// (AutoGCLib.WA_Srv4CSharp:Gen_IsExist)
 /// </summary>
 /// <param name = "intRId">给定的关键字值</param>
 /// <returns>返回是否存在?</returns>
[HttpGet("IsExist")]
public ActionResult IsExist(int intRId,int intPId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsQxRolePotenceV2BL.IsExist(intRId,intPId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/QxRolePotenceV2Api/AddNewRecord
 /// 在Body区传输objQxRolePotenceV2EN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objQxRolePotenceV2EN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsQxRolePotenceV2EN objQxRolePotenceV2EN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxRolePotenceV2JSONObj = clsJSON.GetJsonFromObj(objQxRolePotenceV2EN);
dictParam.Add("strQxRolePotenceV2JSONObj", strQxRolePotenceV2JSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 if (clsQxRolePotenceV2BL.IsExist(objQxRolePotenceV2EN.RId,objQxRolePotenceV2EN.PId) == true)
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objQxRolePotenceV2EN.RId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsQxRolePotenceV2BL.AccessFldValueNull(objQxRolePotenceV2EN);
bool bolResult = objQxRolePotenceV2EN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/QxRolePotenceV2Api/AddNewRecordWithReturnKey
 /// 在Body区传输objQxRolePotenceV2EN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objQxRolePotenceV2EN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsQxRolePotenceV2EN objQxRolePotenceV2EN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objQxRolePotenceV2EN", JsonConvert.SerializeObject(objQxRolePotenceV2EN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsQxRolePotenceV2BL.AccessFldValueNull(objQxRolePotenceV2EN);
string strKey = clsQxRolePotenceV2BL.AddNewRecordBySql2WithReturnKey(objQxRolePotenceV2EN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/QxRolePotenceV2Api/UpdateRecord
 /// 在Body区传输objQxRolePotenceV2EN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strQxRolePotenceV2JSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsQxRolePotenceV2EN objQxRolePotenceV2EN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strQxRolePotenceV2JSONObj = clsJSON.GetJsonFromObj(objQxRolePotenceV2EN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsQxRolePotenceV2BL.SetUpdFlag(objQxRolePotenceV2EN);
    clsQxRolePotenceV2BL.AccessFldValueNull(objQxRolePotenceV2EN);
bool bolResult = objQxRolePotenceV2EN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/QxRolePotenceV2Api/UpdateWithCondition
 /// 在Body区传输objQxRolePotenceV2EN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsQxRolePotenceV2EN objQxRolePotenceV2EN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsQxRolePotenceV2BL.AccessFldValueNull(objQxRolePotenceV2EN);
bool bolResult = objQxRolePotenceV2EN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/QxRolePotenceV2Api/DelRecord/Id
...
public ActionResult DelRecKeyLst(int intRId,int intPId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQxRolePotenceV2BL.DelRecord(intRId,intPId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/QxRolePotenceV2Api/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQxRolePotenceV2BL.DelRecKeyLsts(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/QxRolePotenceV2Api/DelQxRolePotenceV2sByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelQxRolePotenceV2sByCond")]
public ActionResult DelQxRolePotenceV2sByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsQxRolePotenceV2BL.DelQxRolePotenceV2sByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
