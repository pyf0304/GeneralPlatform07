...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_mId_vQxUsers4Synch
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "vQxUsers4Synch"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 28;
public static string[] AttributeName = new string[] {"mId", "IpAddress", "UserId", "UserName", "UserStateId", "UserStateName", "IdentityID", "IdentityDesc", "StuTeacherId", "Password", "DepartmentId", "DepartmentName", "DepartmentAbbrName", "DepartmentTypeId", "DepartmentTypeName", "UpDepartmentId", "UpDepartmentName", "id_College", "EffectiveDate", "EffitiveBeginDate", "EffitiveEndDate", "IsAccessSynch", "AccessSynchDate", "IsExistUserInCurr", "IsSamePwd", "UpdDate", "UpdUser", "Memo"};
//以下是属性变量
