namespace GeneralPlatform.Webform
{
    ...
    ///		wucPrjModule 的摘要说明。
    /// </summary>
    public partial class wucPrjModule : System.Web.UI.UserControl
	{
		...
		public string ModuleId
		{
			get
			{
				return txtModuleId.Text.Trim();
			}
			set
			{
				txtModuleId.Text = value.ToString();
			}
		}
		...
		public string ModuleName
		{
			get
			{
				return txtModuleName.Text.Trim();
			}
			set
			{
				txtModuleName.Text = value.ToString();
			}
		}
		...
		{
			txtModuleId.ReadOnly = bolReadonly;
		}
