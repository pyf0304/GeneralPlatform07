<%@ Register TagPrefix="uc1" TagName="wucPrjFileRelaB" Src="wucPrjFileRelaB.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmPrjFileRelaB_QUDI.aspx.cs"
    Inherits="GeneralPlatform.Webform.wfmPrjFileRelaB_QUDI" Theme="TaiZeTheme" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/tr/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>项目相关文件维护的维护</title>
...
<body>
    <form id="form1" runat="server">
        <table id="tabLayout" cellspacing="2" cellpadding="2" width="100%" border="0" runat="server">
            <tr>
                <td class="navigation">
                    <b><span id="title" runat="server" style="font-size: 13px; font-weight: bold;">项目相关文件维护</span></b>
                </td>
            </tr>
            <tr id="trSelect" runat="server">
                <td>
                    <table border="0" cellspacing="0" cellpadding="0" class="msgtable" width="80%">
                        <tr>
                            <td>
                                <asp:Label ID="lblPrjId_q" Style="z-index: 104;" runat="server" Width="50px" CssClass="NameLabel">项目编号</asp:Label>
                            </td>
                            <td class="style1">
                            ...
                            <td>
                                <asp:Label ID="lblFileName_q" Style="z-index: 110;" runat="server" Width="50px" CssClass="NameLabel">文件名</asp:Label>
                            </td>
                            <td class="style1">
                                <asp:TextBox ID="txtFileName_q" Style="z-index: 111;" runat="server" Width="200px"
            ...
            <tr>
                <td>
                    <table id="tabPrjFileRelaGridView" style="width: 100%" runat="server">
                        <tr>
                            <td>
                                <table style="width: 100%; height: 32px" id="tabGridFunction">
                                    <tr>
                                        <td style="width: 100%;">
                                            <asp:Label ID="lblPrjFileRelaList" runat="server" Style="z-index: 105;" CssClass="RegionTitleH1"
                                                Width="250px">项目相关文件列表</asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvPrjFileRela" Style="z-index: 120;" runat="server" Width="100%"
                                    AutoGenerateColumns="False" PageSize="10" AllowPaging="true" AllowSorting="true"
                                    OnSorting="gvPrjFileRela_Sorting" OnPageIndexChanging="gvPrjFileRela_PageIndexChanging"
                                    OnRowCreated="gvPrjFileRela_RowCreated" OnRowCommand="gvPrjFileRela_RowCommand"
                                    OnRowDeleting="gvPrjFileRela_RowDeleting" OnRowUpdating="gvPrjFileRela_RowUpdating"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IsNeedDownLoad" SortExpression="IsNeedDownLoad" HeaderText="是否需要下载"></asp:BoundField>
            ...
            <tr id="tabEditPrjFileRelaRegion" runat="server">
                <td style="width: 100%;">
                    <uc1:wucPrjFileRelaB ID="wucPrjFileRelaB1" runat="server" />
                    ...
                    <input name="重置" type="reset" class="submit" value="重置" />
                        &nbsp;
                    <asp:Button ID="btnCancelPrjFileRelaEdit" Style="z-index: 107;" runat="server" CssClass="btn btn-outline-info btn-sm"
                        Text="取消编辑" OnClick="btnCancelPrjFileRelaEdit_Click"></asp:Button>
                    </div>
