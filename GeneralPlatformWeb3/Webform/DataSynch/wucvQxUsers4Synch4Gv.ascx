...
<asp:BoundField DataField = "DepartmentAbbrName" SortExpression = "DepartmentAbbrName" HeaderText = "部门"></asp:BoundField>
<asp:BoundField DataField = "UserStateName" SortExpression = "UserStateName" HeaderText = "状态"></asp:BoundField>
...
<asp:BoundField DataField = "IsExistUserInCurr" SortExpression = "IsExistUserInCurr" HeaderText = "是否存在用户?"></asp:BoundField>
<asp:BoundField DataField = "IsSamePwd" SortExpression = "IsSamePwd" HeaderText = "相同密码?"></asp:BoundField>
<asp:BoundField DataField = "IsAccessSynch" SortExpression = "AccessSynchDate" HeaderText = "处理?"></asp:BoundField>
<asp:BoundField DataField = "AccessSynchDate" SortExpression = "AccessSynchDate" HeaderText = "处理日期"></asp:BoundField>
