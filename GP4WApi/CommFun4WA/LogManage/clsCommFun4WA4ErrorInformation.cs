 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCommFun4WA4ErrorInformation
 表名:ErrorInformation(00140050)
 生成代码版本:2021.07.30.1
 生成日期:2021/07/30 00:50:37
 生成者:pyf
...
namespace GeneralPlatform4WApi
{
 ...
 /// </summary>
public class clsCommFun4WA4ErrorInformation : clsCommFun4BL
{
...
clsErrorInformationWApi.ReFreshThisCache();
}
}
}