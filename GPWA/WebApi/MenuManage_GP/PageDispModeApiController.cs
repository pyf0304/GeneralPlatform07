 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:PageDispModeApiController
 表名:PageDispMode(00140107)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/22 17:53:59
 生成者:pyf
 生成服务器IP:
 工程名称:统一平台(0014)
...
{
 /// <summary>
 /// PageDispModeController 的摘要说明
 /// (AutoGCLib.WA_Srv4CSharp:GeneCode)
 /// </summary>
[ApiController]
[Route("[controller]")]
[ApiExplorerSettings(IgnoreApi = true)]
public class  PageDispModeApiController : ControllerBase
{ 

 /// <summary>
 /// 获取当前关键字的记录对象,用对象的形式表示.
 /// 调用方法: GET /api/PageDispModeApi/GetObjByPageDispModeId?PageDispModeId=value
...
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPageDispModeEN });
 }
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetObjLst?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<clsPageDispModeEN> arrPageDispModeObjLst = clsPageDispModeBL.GetObjLst(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetObjLst_Cache?
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
List<clsPageDispModeEN> arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstCache();
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据关键字列表获取相关对象列表
 /// 调用方法: POST /api/PageDispModeapi/GetObjLstByPageDispModeIdLst
...
List<string> lstPageDispModeId = new(arrPageDispModeId);
 try
 {
List<clsPageDispModeEN> arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstByPageDispModeIdLst(lstPageDispModeId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 }
 catch (Exception objException)
 {
...
List<string> lstPageDispModeId = new(arrPageDispModeId);
 try
 {
IEnumerable<clsPageDispModeEN> arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstByPageDispModeIdLstCache(lstPageDispModeId);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件获取顶部对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetTopObjLst?intTopSize=v1&strOrderBy=v2&strWhereCond=v3&
...
clsPubFun_WebApi.AccessException(strMsg, HttpStatusCode.NotFound);
 ...
 try
 {
List<clsPageDispModeEN> arrPageDispModeObjLst = clsPageDispModeBL.GetTopObjLst(objTopPara);
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PageDispModeApi/GetFirstID?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 strPageDispModeId = clsPageDispModeBL.GetFirstID_S(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
        ...
        /// <param name = "strWhereCond">条件串</param>
        /// <returns>返回的第一条记录的关键字值</returns>
        [HttpGet("GetPrimaryIds")]
        public ActionResult GetPrimaryIds(string strWhereCond)
        {
            strWhereCond = strWhereCond.Replace("'% ", "'%");
            string strFunctionName = clsStackTrace.GetCurrFunction();
            Dictionary<string, string> dictParam = new()
          ...
          List<string> arrPageDispModeId;
            try
            {
                arrPageDispModeId = clsPageDispModeBL.GetPrimaryKeyID_S(strWhereCond);
                return Ok(new { errorId = 0, errorMsg = "", returnStrLst = arrPageDispModeId });
            }
            catch (Exception objException)
            {
                string strMsg = string.Format("{0}.(from {1})", objException.Message, clsStackTrace.GetCurrClassFunction());
        ...
        /// <summary>
        /// 获取当前表满足条件的第一条记录的对象
        /// 调用方法: GET /api/PageDispModeApi/GetFirstObj?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 clsPageDispModeEN objPageDispModeEN = clsPageDispModeBL.GetFirstObj_S(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnObj = objPageDispModeEN });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetObjLstByPager?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 List<clsPageDispModeEN> arrPageDispModeObjLst;
 try
 {
 arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstByPager(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 ...
 /// <summary>
 /// 根据条件分页获取JSON对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetObjLstByPager_Cache?intPageIndex=v1&intPageSize=v2&strOrderBy=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 IEnumerable<clsPageDispModeEN> arrPageDispModeObjLst;
 try
 {
 arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstByPagerCache(objPagerPara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 ...
 /// <summary>
 /// 根据条件获取范围内的对象列表
 /// 调用方法: GET /api/PageDispModeApi/GetObjLstByRange?strOrderBy=v1&intMaxNum=v2&intMinNum=v3&strWhereCond=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
 arrPageDispModeObjLst = clsPageDispModeBL.GetObjLstByRange(objRangePara);
 }
 catch (Exception objException)
 {
string strMsg = string.Format("{0}.(from {1})", objException.Message,  clsStackTrace.GetCurrClassFunction());
...
return Ok(new { errorId = 0, errorMsg = "", returnObjLst = arrPageDispModeObjLst });
 ...
 /// <summary>
 /// 功能:获取某一条件的记录数
 /// 调用方法: GET /api/PageDispModeApi/GetRecCountByCond?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intCount = clsPageDispModeBL.GetRecCountByCond(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: GET /api/PageDispModeApi/GetFldValue?strWhereCond=v1&strFldName=v2&strTabName=v3&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
List<string> arrList = clsPageDispModeBL.GetFldValue(strFldName, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:获取给定表中满足条件的记录数, 该表与当前类相关。
 /// 调用方法: GET /api/PageDispModeApi/funSetFldValue?strCondition=v1&strFldName=v2&strTabName=v3&varValue=v4&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecCount = clsPageDispModeBL.SetFldValue(clsPageDispModeEN._CurrTabName, strFldName, strValue, strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:判断是否存在某一条件的记录
 /// 调用方法: GET /api/PageDispModeApi/IsExistRecord?strWhereCond=v1&
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPageDispModeBL.IsExistRecord(strWhereCond);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 判断当前表中是否存在给定关键字值的记录
 /// 调用方法: GET /api/PageDispModeApi/IsExist?PageDispModeId=value
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
bool bolIsExist = clsPageDispModeBL.IsExist(strPageDispModeId);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolIsExist });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来添加记录对象
 /// 调用方法: POST /api/PageDispModeApi/AddNewRecord
 /// 在Body区传输objPageDispModeEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecord)
 /// </summary>
 /// <param name = "objPageDispModeEN">对象</param>
 /// <returns>是否成功</returns>
[HttpPost("AddNewRecord")]
public ActionResult AddNewRecord([FromBody]clsPageDispModeEN objPageDispModeEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPageDispModeJSONObj = clsJSON.GetJsonFromObj(objPageDispModeEN);
dictParam.Add("strPageDispModeJSONObj", strPageDispModeJSONObj);
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 {
string strMsg = string.Format("添加记录时,关键字:[{0}]已经存在!({1})", objPageDispModeEN.PageDispModeId, clsStackTrace.GetCurrClassFunction());
return Ok(new { errorId = 1, errorMsg = strMsg });
 }
 try
 {
    clsPageDispModeBL.AccessFldValueNull(objPageDispModeEN);
bool bolResult = objPageDispModeEN.AddNewRecord();
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PageDispModeApi/AddNewRecordWithReturnKey
 /// 在Body区传输objPageDispModeEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_AddNewRecordWithReturnKey)
 /// </summary>
 /// <param name = "objPageDispModeEN">需要添加的表对象</param>
 /// <returns>返回新添加记录的关键字</returns>
[HttpPost("AddNewRecordWithReturnKey")]
public ActionResult AddNewRecordWithReturnKey(clsPageDispModeEN objPageDispModeEN)
{
...
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
dictParam.Add("objPageDispModeEN", JsonConvert.SerializeObject(objPageDispModeEN));
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 }
try
{
    clsPageDispModeBL.AccessFldValueNull(objPageDispModeEN);
string strKey = clsPageDispModeBL.AddNewRecordBySql2WithReturnKey(objPageDispModeEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 通过JSON对象来修改记录对象
 /// 调用方法: Post /api/PageDispModeApi/UpdateRecord
 /// 在Body区传输objPageDispModeEN的JSON对象
 /// (AutoGCLib.WA_Srv4CSharp:Gen_UpdateRecord)
 /// </summary>
 /// <param name = "strPageDispModeJSONObj">JSON对象字符串</param>
 /// <returns>是否成功</returns>
[HttpPost("UpdateRecord")]
public ActionResult UpdateRecord([FromBody]clsPageDispModeEN objPageDispModeEN)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
string strPageDispModeJSONObj = clsJSON.GetJsonFromObj(objPageDispModeEN);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
    clsPageDispModeBL.SetUpdFlag(objPageDispModeEN);
    clsPageDispModeBL.AccessFldValueNull(objPageDispModeEN);
bool bolResult = objPageDispModeEN.Update();
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 根据条件来修改记录对象
 /// 调用方法: Post /api/PageDispModeApi/UpdateWithCondition
 /// 在Body区传输objPageDispModeEN的JSON对象和strWhereCond条件串
...
public ActionResult UpdateWithCondition(clsPageDispModeEN objPageDispModeEN, string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
 if (string.IsNullOrEmpty(clsSysParaEN.strTempXMLFileName) == true)
{
...
{
    clsPageDispModeBL.AccessFldValueNull(objPageDispModeEN);
bool bolResult = objPageDispModeEN.UpdateWithCondition(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnBool = bolResult });
}
catch (Exception objException)
{
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除关键字所指定的记录
 /// 调用方法: DELETE /api/PageDispModeApi/DelRecord/Id
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPageDispModeBL.DelRecord(strPageDispModeId);
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PageDispModeApi/DelPageDispModes
 ...
 /// <returns>返回删除的记录数</returns>
[HttpPost("DelPageDispModes")]
public ActionResult DelPageDispModes([FromBody]string[] arrPageDispModeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new();
List<string> arrLst = new(arrPageDispModeId);
...
clsPubFun_WebApi.Log4Debug(this, strFunctionName, dictParam);
 try
 {
int intRecNum = clsPageDispModeBL.DelPageDispModes(arrLst);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// 调用方法: POST /api/PageDispModeApi/DelRecords
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPageDispModeBL.DelPageDispModes(arrKey);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 /// <summary>
 /// 功能:删除满足条件的多条记录
 /// 调用方法: POST /api/PageDispModeApi/DelPageDispModesByCond
 /// 在Body区传输{"strWhereCond":"1=1"}
 /// (AutoGCLib.WA_Srv4CSharp:Gen_DelMultiRecordByCond)
 /// </summary>
 /// <param name = "strWhereCond">需要删除的记录条件</param>
 /// <returns>返回删除的记录数。</returns>
[HttpGet("DelPageDispModesByCond")]
public ActionResult DelPageDispModesByCond(string strWhereCond)
{
strWhereCond = strWhereCond.Replace("'% ", "'%");
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new()
...
return Ok(new { errorId = 1, errorMsg = strMsg });
 ...
 try
 {
int intRecNum = clsPageDispModeBL.DelPageDispModesByCond(strWhereCond);
return Ok(new { errorId = 0, errorMsg = "", returnInt = intRecNum });
 }
 catch (Exception objException)
 {
