 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constQxPrjSite4DownLoad
 表名:QxPrjSite4DownLoad
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:37:06
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constQxPrjSite4DownLoad
{
public const string CurrTabName_S = "QxPrjSite4DownLoad"; //当前表名,与该类相关的表名
