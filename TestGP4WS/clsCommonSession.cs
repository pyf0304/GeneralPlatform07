...
namespace GeneralPlatform.Webform
{
    ...
    public class clsCommonSession : clsCommonSessionBase
    {
        ...
        public string QxPrjId
        {
            ...
            {
                string strPrjId;
                strPrjId = (string)System.Web.HttpContext.Current.Session[clsQxProjectsEN.con_QxPrjId];
                if (strPrjId == null)
                {
                    strPrjId = "";
            ...
            set
            {
                ...
                System.Web.HttpContext.Current.Session.Add(clsQxProjectsEN.con_QxPrjId, strPrjId);
            }
        }
