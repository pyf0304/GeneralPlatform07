    ...
    public class clsSubjectRelationExWS
    {
        ...
        public static SubjectRelationServiceExSoapClient GetSubjectRelationServiceExSoapClient()
        {
            if (objSubjectRelationServiceExSoapClient == null)
            {
                ...
                {
                    strServiceUrl = String.Format("http://{0}/{1}/SubjectRelationServiceEx.asmx", clsSysPara.CurrIPAddressAndPort, clsSysPara.CurrPrx);
                }
                else
                {
        ...
        public static List<string> GetUserIdLstByLeader(string strLeaderId)
        {
            ...
            List<string> lstUserIdLst = objSubjectRelationServiceEx.GetQxUserIdLstByLeader(strLeaderId) as List<string>;
            return lstUserIdLst;
        }
    }
}
