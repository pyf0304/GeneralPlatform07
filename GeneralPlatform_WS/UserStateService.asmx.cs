...
namespace GeneralPlatform_WS
{
    ...
    public class UserStateService : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public bool UserState_GetUserState(ref clsUserStateEN objUserState)
        {
        ...
        [WebMethod]
        public bool UserState_GetUserStateV(ref clsUserStateEN objUserState)
        {
            bool bolResult = clsUserStateBL.GetUserState(ref objUserState);
            return bolResult;
        }
        ...
        [WebMethod]
        public bool UserState_AddNewRecordBySql2(clsUserStateEN objUserState)
        {
        ...
        [WebMethod]
        public bool UserState_UpdateBySql2(clsUserStateEN objUserState)
        {
        ...
        [WebMethod]
        public bool UserState_DelUserStates(List<string>  arrStdId)
        {
        ...
        [WebMethod]
        public clsUserStateEN ExposeLogicClass(clsUserStateEN objUserState)
        {
            return objUserState;
        }
    }
