<%@ Register TagPrefix="uc1" TagName="wucSubjectRelation" Src="wucSubjectRelation.ascx" %>

<%@ Page Language="c#" AutoEventWireup="true"
    Inherits="GeneralPlatform.Webform.wfmSubjectRelation_QUDI" Codebehind="wfmSubjectRelation_QUDI.aspx.cs" Theme="TaiZeTheme"  %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/tr/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SubjectRelation的维护</title>
...
<body>
    ...
    <table id="tabLayout" style="z-index: 105; left: 0px; position: absolute; top: 0px"
        ...
        <tr>
            <td>
                <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                    <asp:Label ID="lblViewTitle" runat="server" CssClass="PageTitleH1" >隶属关系维护
                    </asp:Label>
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblUserId_q" Style="z-index: 104;" runat="server" Width="40px" 
                                CssClass="NameLabel">用户</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlUserId_q" Style="z-index: 105;" runat="server" Width="150px"
                                 CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>
                        <td>
                            <asp:Label ID="lblLeaderId_q" Style="z-index: 107;" runat="server" Width="40px" 
                                CssClass="NameLabel">领导</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlLeaderId_q" Style="z-index: 108;" runat="server" Width="150px"
                                 CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>
        ...
        <tr>
            <td>
                <table id="tabSubjectRelationGridView" style="width: 552px" runat="server">
                    <tr>
                        <td>
                            <table style="width: 750px; height: 32px" id="tabGridFunction">
                                <tr>
                                    <td class="style1">
                                        <asp:Label ID="lblSubjectRelationList" runat="server" Height="18px" Style="z-index: 105;"
                                            CssClass="RegionTitleH1">隶属关系列表</asp:Label>
                                    </td>
                                    <td>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvSubjectRelation" Style="z-index: 111;" runat="server" Width="800px"
                                AutoGenerateColumns="False" PageSize="10" AllowPaging="true" AllowSorting="true"
                                OnSorting="gvSubjectRelation_Sorting" OnPageIndexChanging="gvSubjectRelation_PageIndexChanging"
                                OnRowCreated="gvSubjectRelation_RowCreated" OnRowCommand="gvSubjectRelation_RowCommand"
                                OnRowDeleting="gvSubjectRelation_RowDeleting" OnRowUpdating="gvSubjectRelation_RowUpdating"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LeaderId" SortExpression="LeaderId" HeaderText="领导Id">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LeaderUserName" SortExpression="LeaderUserName" HeaderText="领导姓名">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="LeaderDepartmentName" SortExpression="LeaderDepartmentName"
                                        HeaderText="领导部门名称"></asp:BoundField>
                                    <asp:BoundField DataField="IsDirectLeader" SortExpression="IsDirectLeader" HeaderText="是否直接领导">
                                    </asp:BoundField>
        ...
        <tr>
            <td>
                <table id="tabEditSubjectRelationRegion" style="z-index: 111; width: 750px" cellspacing="1"
                    cellpadding="1" width="750" border="1" runat="server">
                    <tr>
                        <td>
                            <asp:Label ID="lblEditSubjectRelation" Style="z-index: 104;" runat="server" CssClass="RegionTitleH1"
                                Height="18px">隶属关系编辑区域</asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Button ID="btnCancelSubjectRelationEdit" Style="z-index: 107;" runat="server"
                                Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelSubjectRelationEdit_Click">
                            </asp:Button>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <uc1:wucSubjectRelation id="wucSubjectRelation1" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
