...
namespace GeneralPlatform4WS
{
    ...
    public class MenuAndPotence
    {
        ...
        {
            if (this.clsUsers_IsExist(strUserId))
            {
                string strUserStateId = this.clsUsers_funGetFldValue("UserStateId", " UserId = '" + strUserId + "'")[0].ToString();
        ...
        public DataTable Get_UserRoles(string strUserId, string strPrjId)
        {
            DataTable objDt = new DataTable();

            objDt = this.Get_UserRoleRelationByJoinUsersV(strUserId, strPrjId);
        ...
        /// <param name="strUserId">用户号</param>
        /// <returns>数据表，其中包含列：用户号 UserId ，姓名UserName， 角色号RoleId ，角色名称Role </returns>
        public List<clsUserRolesEN> Get_UserRoleObjList(string strPrjId, string strUserId)
        {
        ...
        public List<string>  Get_UserRoleIdList(string strPrjId, string strUserId)
        {
        ...
        /// <param name="strUserId">用户号</param>
        /// <returns>角色号RoleId 的列表 </returns>
        public List<string> Get_UserRoleIdList2(string strPrjId, string strUserId)
        {
            List<string> arrRoleIdList = new List<string>();
            DataTable objDT = new DataTable();
        ...
        public string GetRoleNameByRoleId(string strRoleId)
        {
            clsUserRolesEN objUserRoles = new clsUserRolesEN();
            objUserRoles.RoleId = strRoleId;
            clsUserRolesWS.GetUserRolesWs(ref objUserRoles);
        ...
        public List<string>  Get_UserRolePotence(string strRoleId, string strPrjId)
        {
            List<string>  lstPotenceArr = new List<string> ();
            DataTable objDt = this.clsUserGroupPotence_GetUserGroupPotence(" RoleId='" + strRoleId + "' and PrjId='" + strPrjId + "'");
        ...
        public System.Data.DataTable GetRoleIdByPotenceId(List<string>  arrPotenceIds)
        {
            ...
            DataTable objDT = clsUserRolesWS.GetDataTable_UserRolesWs(sbCond.ToString());
            return objDT;
        }
        /// <summary>
        /// 根据权限类型获取权限列表
        ...
        public System.Data.DataTable GetRoleIdByPotenceTypeId(string strPotenceTypeId)
        {
            ...
            DataTable objDT = clsUserRolesWS.GetDataTable_UserRolesWs(sbSQL.ToString());
        ...
        {
            List<string>  lstPotenceArr = new List<string> ();
            DataTable objDt = clsPrjPotenceWS.GetDataTable_PrjPotenceWs(string.Format(" PotenceTypeId='{0}'", strPotenceTypeId));
            return objDt;
        }
        public System.Data.DataTable GetUsersByPotenceAndRoleIds(string strPotenceId, List<string>  arrRoleIds)
        {
            ...
            sbSQL.Append(" (select userid from userrolerelation ");
            ...
            sbSQL.Append(")");
            sbSQL.Append(")");
            DataTable objDT = clsUsersWS.GetDataTable_UsersWs(sbSQL.ToString());

            return objDT;
        }

        public System.Data.DataTable GetUsersByDepartmentAndRoleIds(string strDepartmentId, List<string>  arrRoleIds)
        {
            StringBuilder sbRoleId = new StringBuilder();
            foreach (string strRoleId in arrRoleIds)
            {
        ...
        public System.Data.DataTable GetUsersByDepartmentsAndRoleIds(List<string>  arrDepartmentIdLst, List<string>  arrRoleIds)
        {
            StringBuilder sbRoleId = new StringBuilder();
            foreach (string strRoleId in arrRoleIds)
            {
        ...
        public System.Data.DataTable GetUsersByPotenceAndNoRoleIds(string strPotenceId, List<string>  arrRoleIds)
        {
            StringBuilder sbRoleId = new StringBuilder();
            foreach (string strRoleId in arrRoleIds)
            {
        ...
        public System.Data.DataTable GetUsersByRoleIds(string strRoleId)
        {
            StringBuilder sbSQL = new StringBuilder();
        ...
        {
            List<string>  lstPotenceArr = new List<string> ();
            DataTable objDt = this.clsUserGroupPotence_GetUserGroupPotence(" RoleId='" + strRoleId + "'");
            foreach (DataRow dr in objDt.Rows)
            {
                string strTemp = dr["PotenceId"].ToString();
                if (strTemp != "")
        ...
        //{
        //    //Get_UserRolePotence(strRoleId);
        //    if (this.objPotenceArr != null && this.objPotenceArr.Count != 0)
        //    {

        //        DataTable objDt = clsViewPotence_GetViewPotence(" Viewid='" + ViewId + "' order by level");
        ...
        public string Get_PotenceLevel(string ViewId, string strRoleId)
        {
            ...
            DataTable objDt = clsViewPotence_GetViewPotence(sbCondition.ToString());
            foreach (DataRow dr in objDt.Rows)
            {
                return dr["Level"].ToString();
            }
        ...
        {
            return this.GetUserMenuHTML(strPrjId, strRoleId, strUserId);
        }
        ...
        {
            return this.GetUserMenuHTML2(strPrjId, strRoleId, strUserId);
        }
        ...
        {
            if (clsUsers_IsExistCondRec(" UserId = '" + strCurrUserId + "' and Password = '" + strOldPassword + "'"))
            {
                clsUsers_funSetFldValue("Password", strNewPassword, " UserId='" + strCurrUserId + "'");
                return true;
            }
            else
            {
        ...
        {
            if (clsUsers_IsExistCondRec(" UserId = '" + strCurrUserId + "' and Password = '" + strCurrentUserPassword + "'"))
            {
                if (clsUsers_IsExistCondRec(" UserId = '" + strUserId + "'"))
                {
                    clsUsers_funSetFldValue("Password", strUserNewPassword, " UserId='" + strUserId + "'");
                    return true;
                }
                else
                {
        ...
        {
            return this.Get_RolesOfPrj(strPrjId);
        }
        ...
        /// <param name="UserId"></param>
        /// <param name="RoleId"></param>
        public bool DeleteUser(string strUserId, ref string strResult)
        {
            if (clsUserRoleRelationWS.IsExistRecordWs("UserId = '" + strUserId + "'") == true)
            {
                strResult = "当前用户还存在角色，请该用户的角色删除后才能删除该用户!";
                return true;
            }
            return clsUsersWS.DelRecordWs(strUserId);
        ...
        /// <returns>数据表</returns>
        private DataTable Get_UserRoleRelationByJoinUsers1(string strUserId, string strUserPrjId)
        {
            ...
            DataTable objDT = clsUserRoleRelationWS.GetDataTable_UserRoleRelationVWs(sb.ToString());
        ...
        /// <param name="strUserPrjId">项目号</param>
        /// <returns>数据表</returns>
        private DataTable Get_UserRoleRelationByJoinUsersV(string strUserId, string strUserPrjId)
        {
            StringBuilder sb = new StringBuilder("");
        ...
        private List<String> clsUsers_funGetFldValue(string strFldName, string strCondition)
        {
        ...
        /// <returns></returns>
        private bool clsUsers_IsExist(string strUserId)
        {
        ...
        private bool IsExistRoleIdForPrj(string strRoleId, string strPrjId)
        {
            ...
            if (clsCommDBFunctionWS.IsExistRecord("UserRoles", "RoleId=" + "'" + strRoleId + "' and PrjId='" + strPrjId + "'"))
            {
                return true;
            }
            else
        ...
        private bool AddaUserIntoUsers(string strUserId, string strUserName, string strPassword)
        {
            ...
            return clsUsersWS.AddNewRecordBySql2Ws(objUsers);
        ...
        private bool AddRoleIdForUser(string strUserId, string strRoleId, string strPrjId)
        {
            ...
            if (this.IsExistRoleIdForPrj(strRoleId, strPrjId))
            {
                ...
                clsUserRoleRelationEN objUsers = new clsUserRoleRelationEN();
                objUsers.UserId = strUserId;
                objUsers.RoleId = strRoleId;
                objUsers.PrjId = strPrjId;
                ...
                return clsUserRoleRelationWS.AddNewRecordBySql2Ws(objUsers);
            }
            else
            {
                return false;
        ...
        {
            string strSQL = string.Format(" UserId = '{0}' and RoleId = '{1}' and PrjId = '{2}'", strUserId, strRoleId, strPrjId);
            return clsUserRoleRelationWS.DelUserRoleRelationsByCondWs(strSQL.ToString());
        }
        /// <summary>
        /// 为帐户删除所有角色
        /// </summary>
        ...
        public int Delete_AllRoleForUser(string strUserId, string strPrjId)
        {
            ...
            string strSQL = string.Format(" UserId = '{0}' and PrjId = '{1}'", strUserId, strPrjId);
            return clsUserRoleRelationWS.DelUserRoleRelationsByCondWs(strSQL.ToString());
        ...
        /// <returns></returns>
        private System.Data.DataTable clsUserGroupPotence_GetUserGroupPotence(string strCondition)
        {

            DataTable objDT = clsUserGroupPotenceWS.GetDataTable_UserGroupPotenceWs(strCondition);
        ...
        private System.Data.DataTable clsRoleMenusEx_GetUpMenuTable(string strRoleId, string strPrjId)
        {
            StringBuilder strSQL = new StringBuilder();

            strSQL.AppendFormat(" (RoleId = '{0}') AND (UpMenuId = '00000000') AND ",
                strRoleId);
            strSQL.AppendFormat("( PrjId = '{0}')",
                strPrjId);
            strSQL.Append(" ORDER BY OrderNum");

            DataTable objDT = clsRoleMenusWS.GetDataTable_RoleMenusVWs(strSQL.ToString());
        ...
        /// <param name="strCondtion"></param>
        /// <returns>以DATATABLE形式表示的顶层菜单列表</returns>
        private System.Data.DataTable clsRoleMenusEx_GetSubMenuTable(string strRoleId, string strPrjId)
        {
            StringBuilder strSQL = new StringBuilder();
        ...
        /// <param name="strCondition">条件串</param>
        /// <returns>获取的字段值列表</returns>
        private List<String> clsUserMenus_funGetFldValue(string strFldName, string strCondition)
        {
        ...
        private int clsUsers_funSetFldValue(string strFldName, string strValue, string strCondition)
        {
        ...
        private bool clsUsers_IsExistCondRec(string strCondition)
        {
        ...
        private System.Data.DataTable clsViewPotence_GetViewPotence(string strCondition)
        {
            string strSQL;

            //strSQL = "Select * from ViewPotence where " + strCondition;

            DataTable objDT = clsViewPotenceWS.GetDataTable_ViewPotenceWs(strCondition);
            return objDT;
        }
        ...
        public int clsUsers_funGetRecCountByCond(string strCondtion)
        {
        ...
        private string GetUserMenuHTML(string strCurrPrjId, string strCurrUserRoleId, string strUserId)
        {
            ...
            //			clsPrjMenusEx objPrjMenuEx = new clsPrjMenusEx();
            ...
            arrList = clsUserMenus_funGetFldValue("IsUseRoleMenu", "UserId = '" + strUserId + "'");
            ...
            {
                ///获取顶层菜单
                objDTUpMenu = clsRoleMenusEx_GetUpMenuTable(strCurrUserRoleId, strCurrPrjId);
                ///获取子菜单
                objDTSubMenu = clsRoleMenusEx_GetSubMenuTable(strCurrUserRoleId, strCurrPrjId);
            }
            else
            {
                return "";
        ...
        /// <param name="strUserId"></param>
        /// <returns></returns>
        public string GetUserMenuHTML2(string strCurrPrjId, string strCurrUserRoleId, string strUserId)
        {
            ...
            List<clsUserMenusEN> arr = clsUserMenusWS.GetUserMenusObjList("UserId = '" + strUserId + "'");
            clsUserMenusEN objUserMenus = null;
            if (arr.Count == 0)
            {
            ...
            {
                clsUserMenusEN objUserMenus1 = arr[0] as clsUserMenusEN;
            ...
            if (bolIsUseRoleMenu == true)		//如果使用角色菜单，即用户本身没有自定义菜单。
            {
                ...
                arrUpMenu = clsvRoleMenusWS.GetvRoleMenusObjList(strCondition.ToString());
                ///获取子菜单
                strCondition = new StringBuilder();
                strCondition.AppendFormat("RoleId = '{0}'", strCurrUserRoleId);
                strCondition.AppendFormat(" and PrjId = '{0}'", strCurrPrjId);
                ...
                arrSubMenu = clsvRoleMenusWS.GetvRoleMenusObjList(strCondition.ToString());
            }
            else
            {
                return "";
            ...
            ///5、根据获取的用户菜单列表，组织成HTML菜单串。						
            intMainMenuRow = 1;
            foreach (clsvRoleMenusEN objMainMenuRow in arrUpMenu)
            {
                strHtml.Append("<DIV align=\"left\" class=\"style1\">");
                strHtml.AppendFormat("<TABLE width='94%' border='0' cellPadding='0' cellSpacing='0' borderColor='#2953c0' ID='Table{0}' class=\"style1\" >\n",
                    intMainMenuRow);
...
intMainMenuRow);
        ...
        private void BindSubMenu(List<clsvRoleMenusEN> arrSubMenu, string strUpMenuId, ref StringBuilder strHtml, int intMainMenuRow)
        {
            int intSubMenuRow = 0;
            foreach (clsvRoleMenusEN objSubMenuRow in arrSubMenu)
            {
                ...
                intMainMenuRow.ToString("00"), intSubMenuRow.ToString("00"));
                    ...
                    foreach (clsvRoleMenusEN objLeafMenuRow in arrSubMenu)
                    {
                    ...
                    } // foreach (clsvRoleMenus objLeafMenuRow in arrSubMenu)
                    strHtml.Append("</table>\n");
                    strHtml.Append("</td>");
                    strHtml.Append("</tr>");

                }//非叶子结点
            } //foreach (clsvRoleMenus objSubMenuRow in arrSubMenu)
        }

        public clsUsersEN GetNewUserObj(string strUserId)
        {
            clsUsersEN objUsers = new clsUsersEN();
            objUsers.UserId = strUserId;
            clsUsersWS.GetUsersWs(ref objUsers);
        ...
        /// <returns>数据表</returns>
        private DataTable Get_RolesOfPrj(string PrjId)
        {
            string strSQL = " PrjId='" + PrjId + "'";

            DataTable objDT = clsUserRolesWS.GetDataTable_UserRolesWs(strSQL.ToString());
        ...
        /// <param name="PrjId">项目编号</param>
        /// <returns>数据表</returns>
        public List<clsUserRolesEN> Get_RoleObjListOfPrj(string strPrjId)
        {
            List<clsUserRolesEN> arrLst = clsUserRolesWS.GetUserRolesObjList("PrjId='" + strPrjId + "'");
            return arrLst;
        ...
        /// <param name="PrjId">项目编号</param>
        /// <returns>数据表</returns>
        public List<clsUserRoleRelationEN> Get_RoleUserRelationObjListOfPrj(string strPrjId)
        {
            List<clsUserRoleRelationEN> arrLst = clsUserRoleRelationWS.GetUserRoleRelationObjList("PrjId='" + strPrjId + "'");
            return arrLst;
        ...
        public List<clsUsersEN> Get_UserObjListOfPrj(string strPrjId)
        {
            List<clsUsersEN> arrLst = clsUsersWS.GetUsersObjList(" userid in (select userid from prjUserRelation where PrjId='" + strPrjId + "')");
            return arrLst;
        }
        ...
        /// <param name="PrjId">项目编号</param>
        /// <returns>对象列表</returns>
        public System.Data.DataTable Get_UserDataTableOfPrj(string strPrjId)
        {
            string strSQL = " userid in (select userid from prjUserRelation where PrjId='" + strPrjId + "')";
            DataTable objDT = clsUsersWS.GetDataTable_UsersVWs(strSQL.ToString());
        ...
        /// </summary>
        /// <returns>对象列表</returns>
        public List<clsDepartmentInfoEN> Get_DepartMentObjList()
        {
            List<clsDepartmentInfoEN> arrLst = clsDepartmentInfoWS.GetDepartmentInfoObjList("1=1");
            return arrLst;
        ...
        /// </summary>
        /// <returns>对象列表</returns>
        public List<clsUserStateEN> Get_UserStateObjList()
        {
            List<clsUserStateEN> arrLst = clsUserStateWS.GetUserStateObjList("1=1");
            return arrLst;
        ...
        {
            System.Data.DataTable objDT = clsDepartmentInfoWS.GetDataTable_DepartmentInfoWs("1=1");
            return objDT;
