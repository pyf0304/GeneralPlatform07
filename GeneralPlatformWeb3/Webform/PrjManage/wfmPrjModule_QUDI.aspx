<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="GeneralPlatform.Webform.wfmPrjModule_QUDI" Codebehind="wfmPrjModule_QUDI.aspx.cs"  Theme="TaiZeTheme" %>
                            ...
                            <td>
                                <asp:DataGrid ID="dgPrjModule" runat="server"  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="PrjName" SortExpression="QxPrjId" HeaderText="项目"></asp:BoundColumn>
