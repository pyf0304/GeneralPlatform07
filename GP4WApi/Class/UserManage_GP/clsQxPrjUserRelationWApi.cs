...
/// 静态类
/// </summary>
public static class  clsQxPrjUserRelationWApi_Static
{
...
try
{
objQxPrjUserRelationEN.sfUpdFldSetStr = objQxPrjUserRelationEN.getsfUpdFldSetStr();
clsQxPrjUserRelationWApi.CheckPropertyNew(objQxPrjUserRelationEN); 
bool bolResult = clsQxPrjUserRelationWApi.UpdateRecord(objQxPrjUserRelationEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxPrjUserRelationEN objQxPrjUserRelationEN)
{
//检测记录是否存在
...
{
clsQxPrjUserRelationWApi.CheckPropertyNew(objQxPrjUserRelationEN); 
bool bolResult = clsQxPrjUserRelationWApi.AddNewRecord(objQxPrjUserRelationEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
return bolResult;
}
catch (Exception objException)
...
{
clsQxPrjUserRelationWApi.CheckPropertyNew(objQxPrjUserRelationEN); 
bool bolResult = clsQxPrjUserRelationWApi.UpdateWithCondition(objQxPrjUserRelationEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
return bolResult;
}
catch (Exception objException)
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxPrjUserRelationWApi
{
private static readonly string mstrApiControllerName = "QxPrjUserRelationApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsQxPrjUserRelationWApi()
 {
 }
...
if (!Object.Equals(null, objQxPrjUserRelationEN.UpdDate) && GetStrLen(objQxPrjUserRelationEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objQxPrjUserRelationEN.UpdUser) && GetStrLen(objQxPrjUserRelationEN.UpdUser) > 20)
{
...
clsQxPrjUserRelationEN objQxPrjUserRelationEN;
...
objQxPrjUserRelationEN = JsonConvert.DeserializeObject<clsQxPrjUserRelationEN>(strJson);
return objQxPrjUserRelationEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxPrjUserRelationEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsQxPrjUserRelationEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxPrjUserRelationEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxPrjUserRelationEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsQxPrjUserRelationEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxPrjUserRelationEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxPrjUserRelationEN> arrObjLst; 
...
try
{
 clsQxPrjUserRelationEN objQxPrjUserRelationEN = clsQxPrjUserRelationWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxPrjUserRelations(List<string> arrmId)
{
string strAction = "DelQxPrjUserRelations";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelQxPrjUserRelationsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxPrjUserRelationEN objQxPrjUserRelationEN)
{
...
public static string AddNewRecordWithReturnKey(clsQxPrjUserRelationEN objQxPrjUserRelationEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxPrjUserRelationEN objQxPrjUserRelationEN)
{
if (string.IsNullOrEmpty(objQxPrjUserRelationEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxPrjUserRelationEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxPrjUserRelationEN objQxPrjUserRelationEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxPrjUserRelationEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxPrjUserRelationEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxPrjUserRelationEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxPrjUserRelationEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxPrjUserRelationEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxPrjUserRelationEN objInFor in arrObj)
{
//Rows
...
if (clsQxPrjUserRelationWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxPrjUserRelationEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxPrjUserRelationWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsQxPrjUserRelationEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxPrjUserRelation.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conQxPrjUserRelation.QxPrjId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjUserRelation.UserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjUserRelation.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjUserRelation.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conQxPrjUserRelation.Memo, Type.GetType("System.String"));
foreach (clsQxPrjUserRelationEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxPrjUserRelation.mId] = objInFor[conQxPrjUserRelation.mId];
objDR[conQxPrjUserRelation.QxPrjId] = objInFor[conQxPrjUserRelation.QxPrjId];
objDR[conQxPrjUserRelation.UserId] = objInFor[conQxPrjUserRelation.UserId];
objDR[conQxPrjUserRelation.UpdDate] = objInFor[conQxPrjUserRelation.UpdDate];
objDR[conQxPrjUserRelation.UpdUser] = objInFor[conQxPrjUserRelation.UpdUser];
objDR[conQxPrjUserRelation.Memo] = objInFor[conQxPrjUserRelation.Memo];
