...
{
throw new Exception(string.Format("(errid:Data000007)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSet)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 ...
 objDS = objSQL.GetDataSet(strSQL, "vSetFieldVisibility");
 return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000008)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSetByCondBySP)", objException.Message));
}
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDS = objSQL.ExecSPReturnDS("vSetFieldVisibility_SelectByCond",values, "vSetFieldVisibility");
return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000009)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSet_Top)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
public System.Data.DataSet GetDataSetByRange(string strCondition, string strOrderBy, int intMinNum, int intMaxNum)
{
     if (intMinNum <=  0)
 {
 throw new Exception(string.Format("在输入范围的最小值{0}非法,应该不小于0,请检查!(clsvSetFieldVisibilityDA: GetvSetFieldVisibilityByRange)", intMinNum));
 }
 if (intMaxNum > 6553005)
 {
 throw new Exception(string.Format("在输入范围的最大值{0}非法,应该不大于6553005(可以用其他条件来限制记录的条数),请检查!(clsvSetFieldVisibilityDA: GetvSetFieldVisibilityByRange)", intMaxNum));
 }
 if (intMaxNum < intMinNum)
 {
 throw new Exception(string.Format("在输入范围的最大值[{0}]不能小于最小值[{1}],非法,请检查!(clsvSetFieldVisibilityDA: GetvSetFieldVisibilityByRange)", intMaxNum, intMinNum));
 }
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000010)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSetByRange)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 objSQL = clsvSetFieldVisibilityDA.GetSpecSQLObj();
 strSQL = string.Format("Select top {1} * from vSetFieldVisibility a where {0} And a.mId not in (Select Top {2} mId From vSetFieldVisibility Where {0})", strCondition, intMaxNum - intMinNum + 1, intMinNum - 1);
 objDS = objSQL.GetDataSet(strSQL, "vSetFieldVisibility");
return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000066)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSet)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000067)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSet)ByRange", objException.Message));
}
try
 {
 if (bolIsCheckSQLAttack  ==  true)
...
{
throw new Exception(string.Format("(errid:Data000067)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataSetByRange)", objException.Message));
}
string strSQL; 
 System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000020)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTable)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000077)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTable)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000023)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTable_Top)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000026)在分页查询中输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTableByPager)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000027)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 ...
 {
 strSQL = string.Format("Select top {1} * from vSetFieldVisibility a where {0} And a.mId not in (Select Top {2} mId From vSetFieldVisibility Where {0} order by {3}) order by {3}", strCondition, intMaxNum - intMinNum + 1, intMinNum - 1, strOrderBy);
 }
objDT = objSQL.GetDataTable(strSQL);
return objDT;
}
...
{
throw new Exception(string.Format("(errid:Data000070)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000071)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000030)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA: GetDataTableByCondBySP)", objException.Message));
}
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDT = objSQL.ExecSpReturnDT("vSetFieldVisibility_SelectByCond",values);
return objDT;
}
...
try
{
objvSetFieldVisibilityEN.mId = TransNullToInt(objRow[convSetFieldVisibility.mId].ToString().Trim()); //流水号
...
return arrObjLst;
 ...
 /// <param name = "strCondition">给定条件</param>
 /// <returns>返回对象列表</returns>
public List<clsvSetFieldVisibilityEN> GetObjLstBySP(string strCondition)
{
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000038)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA:GetObjLstBySP)", objException.Message));
}
List<clsvSetFieldVisibilityEN> arrObjLst = new List<clsvSetFieldVisibilityEN>(); 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("根据条件获取对象列表时,发生:{0},请检查!(clsvSetFieldVisibilityDA: GetObjLstBySP)", objException.Message));
}
objvSetFieldVisibilityEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
	arrObjLst.Add(objvSetFieldVisibilityEN);
	}
...
try
{
 objvSetFieldVisibilityEN.mId = TransNullToInt(objDT.Rows[0][convSetFieldVisibility.mId].ToString().Trim()); //流水号(字段类型:bigint,字段长度:8,是否可空:False)
 ...
 objvSetFieldVisibilityEN.Memo = objDT.Rows[0][convSetFieldVisibility.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
try
{
 objvSetFieldVisibilityEN.mId = Int32.Parse(objRow[convSetFieldVisibility.mId].ToString().Trim()); //流水号(字段类型:bigint,字段长度:8,是否可空:False)
 ...
 objvSetFieldVisibilityEN.Memo = objRow[convSetFieldVisibility.Memo] == DBNull.Value ? null : objRow[convSetFieldVisibility.Memo].ToString().Trim(); //备注(字段类型:varchar,字段长度:1000,是否可空:True)
}
 catch(Exception objException)
{
...
return objvSetFieldVisibilityEN;
 ...
 /// <param name = "objvSetFieldVisibilityEN">需要添加到数据库中的对象</param>
 /// <returns>是否成功</returns>
public bool GetvSetFieldVisibilityOneBySP(clsvSetFieldVisibilityEN objvSetFieldVisibilityEN)
{
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
...
//			 gobjSQL.SPConfigXMLFile = "..\\Parameter.xml"
 ArrayList values = new ArrayList()
{
 objvSetFieldVisibilityEN.mId
};
 objDT = objSQL.ExecSpReturnDT("vSetFieldVisibility_SelectOne",values);
if (objDT.Rows.Count  ==  0)
{
return false;
}
...
try
{
	clsvSetFieldVisibilityEN objvSetFieldVisibilityEN = new clsvSetFieldVisibilityEN()
{
mId = TransNullToInt(objRow[convSetFieldVisibility.mId].ToString().Trim()), //流水号
...
Memo = objRow[convSetFieldVisibility.Memo] == DBNull.Value ? null : objRow[convSetFieldVisibility.Memo].ToString().Trim() //备注
};
objvSetFieldVisibilityEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
return objvSetFieldVisibilityEN;
}
...
throw new Exception(string.Format("在根据条件获取第一个对象时,发生:{0},请检查!(clsvSetFieldVisibilityDA: GetFirstObj)", objException.Message));
 ...
 /// <param name = "strCondition">给定条件</param>
 /// <returns>返回满足条件的第一个对象</returns>
public clsvSetFieldVisibilityEN GetFirstObjBySP(string strCondition)
{
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000040)在输入条件中含有{0},请检查!(clsvSetFieldVisibilityDA:GetFirstObjBySP)", objException.Message));
}
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDT = objSQL.ExecSpReturnDT("vSetFieldVisibility_SelectTop1ByCond",values);
if (objDT.Rows.Count  ==  0)
{
return null;
}
...
ArrayList arrReturn = objSQL.ExecSpWithOutPut("vSetFieldVisibility_IsExist", values);
