...
namespace GeneralPlatform.Webform
{
    ...
    ///		wucUsers 的摘要说明。
    /// </summary>
    public partial class wucUsers_School : System.Web.UI.UserControl
	{
		...
		public string StuIdTeacherId
		{
			get
			{
				return txtStuIdTeacherId.Text.Trim();
			}
			set
			{
				txtStuIdTeacherId.Text = value.ToString();
			}
		}
        ...
        public bool IsLeaved
        {
            get
            {
                return chkIsLeaved.Checked;
            }
            set
            {
                chkIsLeaved.Checked = value;
            }
        }
        ...
        public void SetAllCtrlFalseExceptIsLeaved()
        {
            txtUserId.Enabled = false;
            txtStuIdTeacherId.Enabled = false;
            ddlDepartmentId.Enabled = false;
            ddlUserStateId.Enabled = false;
            txtCardNo.Enabled = false;
            chkIsLeaved.Enabled = false;
