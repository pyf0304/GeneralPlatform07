 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxPrjDataBase
 表名:vQxPrjDataBase
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:39:22
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPrjDataBase
{
public const string CurrTabName_S = "vQxPrjDataBase"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "QxPrjDataBaseId"; //当前表中的关键字名称,与该类相关的表中关键字名
