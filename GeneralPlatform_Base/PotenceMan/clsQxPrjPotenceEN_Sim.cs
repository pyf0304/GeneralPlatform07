 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxPrjPotenceEN_Sim
 表名:QxPrjPotence
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:34:55
 生成者:潘以锋
...
public class clsQxPrjPotenceEN_Sim 
{
//以下是属性变量
...
private string mstrFuncModuleId;    //FuncModuleId
...
/// <summary>
/// FuncModuleId(说明:;字段类型:char;字段长度:4;是否可空:False)
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:ToString2)
/// </summary>
  [DataMember]//非常重要
