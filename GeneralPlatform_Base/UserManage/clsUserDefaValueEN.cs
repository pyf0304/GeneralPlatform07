...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_mId_UserDefaValue
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
protected string mstrMemo;    //备注
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_DefaValName = "DefaValName";    //缺省值名称
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_UserDefaValue = "UserDefaValue";    //用户缺省值
...
else if (strAttributeName  ==  con_DefaValName)
{
...
else if (strAttributeName  ==  con_UserDefaValue)
{
...
mstrUserDefaValue = value.ToString();
 AddUpdatedFld(con_UserDefaValue);
}
else if (strAttributeName  ==  con_UpdDate)
{
...
else if (con_DefaValName  ==  AttributeName[intIndex])
{
return mstrDefaValName;
}
...
else if (con_UserDefaValue  ==  AttributeName[intIndex])
{
return mstrUserDefaValue;
}
