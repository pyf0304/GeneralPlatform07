 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxPrjTabExWApi
 表名:QxPrjTab(00140096)
 生成代码版本:2020.01.04.1
 生成日期:2020/01/06 04:41:06
 生成者:
...
namespace GP4WApi
{
public static class clsQxPrjTabExWApi_Static
{
...
clsQxPrjTabWApi.CopyTo(objQxPrjTabENS, objQxPrjTabENT);
...
public static bool EditRecordEx(this clsQxPrjTabEN objQxPrjTabEN)
{
...
try
{
bool bolResult = clsQxPrjTabExWApi.EditRecordEx(objQxPrjTabEN);
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxPrjTabExWApi
{
private static readonly string mstrApiControllerName = "QxPrjTabExApi";
 /// <summary>
 /// 静态的对象列表,用于缓存,针对记录较少,作为参数表可以使用
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
public static List<clsQxPrjTabEN> arrQxPrjTabObjLst_Cache = null;
 /// <summary>
 /// 从缓存中查找失败的次数
 /// (AutoGCLib.WA_AccessEx4CSharp:GeneCode)
 /// </summary>
...
public static bool EditRecordEx(clsQxPrjTabEN objQxPrjTabEN)
{
