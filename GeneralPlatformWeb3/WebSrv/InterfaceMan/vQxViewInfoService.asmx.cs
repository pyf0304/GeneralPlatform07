...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
 {
["objvQxViewInfoEN"] = clsvQxViewInfoBL.SerializeObjToXMLStr(objvQxViewInfoEN)
 };
...
return bolResult;
 ...
 /// <returns>表对象</returns>
[WebMethod]
public clsvQxViewInfoEN vQxViewInfo_GetObjByViewId(string strViewId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
clsvQxViewInfoEN objvQxViewInfoEN = clsvQxViewInfoBL.GetObjByViewId(strViewId);
...
[WebMethod]
public List<clsvQxViewInfoEN> vQxViewInfo_GetObjLst(string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
List<clsvQxViewInfoEN> arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetObjLst(strWhereCond);
return arrvQxViewInfoObjLst;
 ...
 /// <returns>返回对象列表</returns>
[WebMethod]
public List<clsvQxViewInfoEN> vQxViewInfo_GetTopObjLst(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
List<clsvQxViewInfoEN> arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
return arrvQxViewInfoObjLst;
}
...
[WebMethod]
public clsvQxViewInfoEN vQxViewInfo_GetFirstObj_S(string strWhereCond) 
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 try
 {
 clsvQxViewInfoEN objvQxViewInfoEN = clsvQxViewInfoBL.GetFirstObj_S(strWhereCond);
 return objvQxViewInfoEN;
 }
 catch (Exception objException)
 {
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objvQxViewInfoEN = clsvQxViewInfoBL.GetObjByViewId(strViewId);
 if (objvQxViewInfoEN == null) return "";
 }
 catch (Exception objException)
 {
string strMsg = "根据关键字获取对象出错!(vQxViewInfoService:GetJSONObjByViewId)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObj<clsvQxViewInfoEN>(objvQxViewInfoEN);
 return strJSON;
     }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objvQxViewInfoEN = clsvQxViewInfoBL.GetFirstObj_S(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取第一条记录的对象出错!(vQxViewInfoService:GetFirstJSONObj)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObj<clsvQxViewInfoEN>(objvQxViewInfoEN);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetObjLst(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(vQxViewInfoService:GetJSONObjLst)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrvQxViewInfoObjLst);
 return strJSON;
 }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(vQxViewInfoService:GetJSONObjLst)\r\n" + objException.Message;
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsvQxViewInfoEN> lstvQxViewInfoObjLst = clsvQxViewInfoBL.GetObjLst(strWhereCond);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsvQxViewInfoBL.SerializeObjLstToXMLStr(lstvQxViewInfoObjLst);
}
catch (Exception objException)
{
clsPubVar_WS.objLog.WriteDebugLog(objException.Message);
...
return strXmlString;
 ...
 /// <returns>返回一个<clsvQxViewInfoEN>对象列表XML串</returns>
[WebMethod]
public string vQxViewInfo_SerializeTopObjLstToXMLStr(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsvQxViewInfoEN> lstvQxViewInfoObjLst = clsvQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsvQxViewInfoBL.SerializeObjLstToXMLStr(lstvQxViewInfoObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetObjLstByPager(intPageIndex, intPageSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件分页获取的对象列表出错!(vQxViewInfoService:GetJSONObjLstByPager)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrvQxViewInfoObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
int intCount = clsvQxViewInfoBL.GetRecCountByCond(strWhereCond);
return intCount;
}
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrvQxViewInfoObjLst = clsvQxViewInfoBL.GetObjLstByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取指定范围内的对象列表出错!(vQxViewInfoService:GetJSONObjLstByRange)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrvQxViewInfoObjLst);
 ...
 [WebMethod]
 public List<clsvQxViewInfoEN> GetObjLstByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsvQxViewInfoBL.GetDataSet(strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet vQxViewInfo_GetTopDataSet(int intTopSize, string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsvQxViewInfoBL.GetDataSet_Top(intTopSize, strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet vQxViewInfo_GetDataSetByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsvQxViewInfoBL.GetDataSetByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
return objDS;
}
}
}