 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsXzSchoolEN_Sim
 表名:XzSchool
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:40:45
 生成者:潘以锋
...
public class clsXzSchoolEN_Sim 
{
//以下是属性变量
...
private bool mbolIsCurrentUse;    //是否当前使用
private string mstrMemo;    //备注
private string mstrSchoolNameA;    //SchoolNameA
