<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucPrjFileRelaB.ascx.cs"
    Inherits="GeneralPlatform.Webform.wucPrjFileRelaB" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
    ...
    <tr>
        <td align="right">
            <asp:Label ID="lblFilePath" runat="server" CssClass="NameControl">文件路径</asp:Label>
        </td>
        <td class="ValueTD">
            <asp:TextBox ID="txtFilePath" runat="server" CssClass="ValueControl" 
                Width="400px"></asp:TextBox>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <asp:CheckBox ID="chkIsNeedDownLoad" runat="server" Text="" CssClass="Check_Defa">
            </asp:CheckBox>
        </td>
    </tr>
    <tr>
