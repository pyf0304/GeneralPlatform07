...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_ModuleId_vQxPrjModule
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "vQxPrjModule"; //当前表名,与该类相关的表名
...
get
{
if (strAttributeName  ==  con_ModuleId)
{
return mstrModuleId;
}
...
get
{
if (con_ModuleId  ==  AttributeName[intIndex])
{
return mstrModuleId;
}
