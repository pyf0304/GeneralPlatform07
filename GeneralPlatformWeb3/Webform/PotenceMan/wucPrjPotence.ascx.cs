...
namespace GeneralPlatform.Webform
{
    ...
    public partial class wucPrjPotence : System.Web.UI.UserControl
	{
        ...
        public string OperateMode
        {
            get
            {
                return hidOperateMode.Value;
            }
            set
            {
                hidOperateMode.Value = value;
            }
        }
		...
		public string PotenceTypeId
		{
			get
			{
				if (ddlPotenceTypeId.SelectedValue == "0")
					return "";
				return ddlPotenceTypeId.SelectedValue;
			}
			set
			{
				if (value == "")
				{
					ddlPotenceTypeId.SelectedValue = "0";
				}
				else
				{
                    try
                    {
                        ddlPotenceTypeId.SelectedValue = value;
                    }
		...
		public void Clear()
		{
			...
			txtPotenceName.Text = "";
			ddlPotenceTypeId.SelectedIndex = 0;
			txtMemo.Text = "";
		}
		/// <summary>
		...
		public void SetDdl_PotenceTypeId(string strPrjId)
		{
            clsQxPotenceTypeBLEx.BindDdl_PotenceTypeIdEx(ddlPotenceTypeId, strPrjId);
		}
        public void SetDdl_MenuId(string strPrjId)
        {
            clsQxPrjMenusBLEx.BindDdl_MenuId4IsLeafEx(ddlMenuId, strPrjId);
        }
        protected void ddlPotenceTypeId_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlPotenceTypeId.SelectedIndex > 0)
            {
                ...
                {
                    this.PotenceId = clsQxPrjPotenceBL.GetMaxStrIdByPrefix_S(ddlPotenceTypeId.SelectedValue.ToString());
                }
            }
        }
        protected void ddlPrjId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                SetDdl_PotenceTypeId(ddlPrjId.SelectedValue.ToString());
            }
        }
}
}