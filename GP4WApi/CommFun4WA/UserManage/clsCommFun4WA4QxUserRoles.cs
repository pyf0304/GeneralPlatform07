 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCommFun4WA4QxUserRoles
 表名:QxUserRoles(00140014)
 生成代码版本:2021.07.30.1
 生成日期:2021/07/30 00:50:06
 生成者:pyf
...
clsvQxUserRolesWApi.ReFreshThisCache();
clsvQxUserRolesByUserNumWApi.ReFreshThisCache();
clsvQxUserRolesByMenuNumWApi.ReFreshThisCache();
clsvQxUserRolesByPotenceNumWApi.ReFreshThisCache();
}
}
}