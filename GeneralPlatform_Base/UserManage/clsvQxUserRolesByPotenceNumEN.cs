...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_RoleId_vQxUserRolesByPotenceNum
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "vQxUserRolesByPotenceNum"; //当前表名,与该类相关的表名
...
protected int mintPotenceNum;    //PotenceNum
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_PotenceNum = "PotenceNum";    //PotenceNum
...
/// </summary>
 ...
 _CurrTabName = "vQxUserRolesByPotenceNum";
...
else if (strAttributeName  ==  con_PotenceNum)
{
...
else if (con_PotenceNum  ==  AttributeName[intIndex])
{
return mintPotenceNum;
}
return null;
