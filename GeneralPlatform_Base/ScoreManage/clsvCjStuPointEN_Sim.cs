 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvCjStuPointEN_Sim
 表名:vCjStuPoint
 生成代码版本:2017.11.11.1
 生成日期:2017/11/22 05:20:04
 生成者:潘以锋
...
public class clsvCjStuPointEN_Sim 
{
//以下是属性变量

private string mstrStuID;    //学号
private string mstrStuName;    //姓名
private string mstrSexID;    //性别编号
private string mstrid_AdminClass;    //行政班流水号
private string mstrAdminClassID;    //行政班代号
private string mstrAdminClassName;    //行政班名称
private string mstrid_GradeBase;    //年级流水号
private string mstrGradeBaseID;    //年级代号
private string mstrGradeBaseName;    //年级名称
private string mstrEntryDay;    //EntryDay
private string mstrGradeName;    //GradeName
private string mstrSelCrsGroup;    //SelCrsGroup
