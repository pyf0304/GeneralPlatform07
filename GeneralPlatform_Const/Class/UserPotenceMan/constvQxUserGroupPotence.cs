 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxUserGroupPotence
 表名:vQxUserGroupPotence
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:35:30
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxUserGroupPotence
{
public const string CurrTabName_S = "vQxUserGroupPotence"; //当前表名,与该类相关的表名
