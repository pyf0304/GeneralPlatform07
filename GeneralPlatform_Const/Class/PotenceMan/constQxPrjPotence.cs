 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constQxPrjPotence
 表名:QxPrjPotence
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:34:54
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constQxPrjPotence
{
public const string CurrTabName_S = "QxPrjPotence"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "PotenceId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"PotenceId", "PotenceName", "QxPrjId", "FuncModuleId", "PotenceTypeId", "MenuId", "UpdDate", "UpdUserId", "Memo"};
//以下是属性变量
