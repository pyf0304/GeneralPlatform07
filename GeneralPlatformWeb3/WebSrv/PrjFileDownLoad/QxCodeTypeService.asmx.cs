...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
 {
["objQxCodeTypeEN"] = clsQxCodeTypeBL.SerializeObjToXMLStr(objQxCodeTypeEN)
 };
...
return bolResult;
 ...
 /// <returns>表对象</returns>
[WebMethod]
public clsQxCodeTypeEN QxCodeType_GetObjByQxCodeTypeId(string strQxCodeTypeId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
[WebMethod]
public List<clsQxCodeTypeEN> QxCodeType_GetObjLst(string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
return arrQxCodeTypeObjLst;
 ...
 /// <returns>返回对象列表</returns>
[WebMethod]
public List<clsQxCodeTypeEN> QxCodeType_GetTopObjLst(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
List<clsQxCodeTypeEN> arrQxCodeTypeObjLst = clsQxCodeTypeBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
return arrQxCodeTypeObjLst;
}
...
[WebMethod]
public clsQxCodeTypeEN QxCodeType_GetFirstObj_S(string strWhereCond) 
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objQxCodeTypeEN = clsQxCodeTypeBL.GetObjByQxCodeTypeId(strQxCodeTypeId);
 if (objQxCodeTypeEN == null) return "";
 }
 catch (Exception objException)
 {
string strMsg = "根据关键字获取对象出错!(QxCodeTypeService:GetJSONObjByQxCodeTypeId)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObj<clsQxCodeTypeEN>(objQxCodeTypeEN);
 return strJSON;
     }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objQxCodeTypeEN = clsQxCodeTypeBL.GetFirstObj_S(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取第一条记录的对象出错!(QxCodeTypeService:GetFirstJSONObj)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObj<clsQxCodeTypeEN>(objQxCodeTypeEN);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxCodeTypeObjLst = clsQxCodeTypeBL.GetObjLst(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(QxCodeTypeService:GetJSONObjLst)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxCodeTypeObjLst);
 return strJSON;
 }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxCodeTypeObjLst = clsQxCodeTypeBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(QxCodeTypeService:GetJSONObjLst)\r\n" + objException.Message;
...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strQxCodeTypeJSONObj"] = strQxCodeTypeJSONObj
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxCodeTypeEN objQxCodeTypeEN = clsJSON.GetObjFromJson<clsQxCodeTypeEN>(strQxCodeTypeJSONObj);
bool bolResult = objQxCodeTypeEN.AddNewRecord();
return bolResult;
 }
 catch (Exception objException)
 {
string strMsg = "通过JSON对象来添加记录对象出错!(QxCodeTypeService:QxCodeType_AddNewRecordBySql2ByJSON)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
}
...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strQxCodeTypeObjXml"] = strQxCodeTypeObjXml
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
bool bolResult = clsQxCodeTypeBL.AddNewRecordBySql_XML(strQxCodeTypeObjXml);
return bolResult;
}
...
return bolResult;
 ...
 {
string strMsg = "通过JSON对象来修改记录对象出错!(QxCodeTypeService:QxCodeType_UpdateBySql2ByJSON)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
}
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
bool bolResult = clsQxCodeTypeBL.UpdateBySql_XML(strQxCodeTypeObjXml);
return bolResult;
}
...
{
List<string> arrQxCodeTypeId = clsJSON.GetObjLstFromJson<string>(strJSON4Keys);
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["arrQxCodeTypeId"] = clsArray.GetSqlInStrByArray(arrQxCodeTypeId, true)
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
int intRecNum = clsQxCodeTypeBL.DelQxCodeTypes(arrQxCodeTypeId);
return intRecNum;
}
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsQxCodeTypeEN> lstQxCodeTypeObjLst = clsQxCodeTypeBL.GetObjLst(strWhereCond);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsQxCodeTypeBL.SerializeObjLstToXMLStr(lstQxCodeTypeObjLst);
}
catch (Exception objException)
{
clsPubVar_WS.objLog.WriteDebugLog(objException.Message);
...
return strXmlString;
 ...
 /// <returns>返回一个<clsQxCodeTypeEN>对象列表XML串</returns>
[WebMethod]
public string QxCodeType_SerializeTopObjLstToXMLStr(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsQxCodeTypeEN> lstQxCodeTypeObjLst = clsQxCodeTypeBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsQxCodeTypeBL.SerializeObjLstToXMLStr(lstQxCodeTypeObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxCodeTypeObjLst = clsQxCodeTypeBL.GetObjLstByPager(intPageIndex, intPageSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件分页获取的对象列表出错!(QxCodeTypeService:GetJSONObjLstByPager)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxCodeTypeObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string[] sstrQxCodeTypeId = strKeyIdLst.Trim().Split(',');
List <string> arrQxCodeTypeId = new List<string>();
foreach (string strQxCodeTypeId in sstrQxCodeTypeId)
{
if (string.IsNullOrEmpty(strQxCodeTypeId) == false)
{
arrQxCodeTypeId.Add(strQxCodeTypeId);
}
}
int intRecNum = clsQxCodeTypeBL.DelQxCodeTypes(arrQxCodeTypeId);
return intRecNum;
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxCodeTypeObjLst = clsQxCodeTypeBL.GetObjLstByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取指定范围内的对象列表出错!(QxCodeTypeService:GetJSONObjLstByRange)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxCodeTypeObjLst);
 ...
 [WebMethod]
 public List<clsQxCodeTypeEN> GetObjLstByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxCodeTypeBL.GetDataSet(strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet QxCodeType_GetTopDataSet(int intTopSize, string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxCodeTypeBL.GetDataSet_Top(intTopSize, strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet QxCodeType_GetDataSetByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxCodeTypeBL.GetDataSetByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
return objDS;
}
}
}