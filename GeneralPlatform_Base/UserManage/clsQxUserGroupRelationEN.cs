...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_mId_QxUserGroupRelation
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "QxUserGroupRelation"; //当前表名,与该类相关的表名
...
protected bool mbolIsDefault;    //是否默认
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_ManageId = "ManageId";    //ManageId

 /// <summary>
 /// 常量:"ManageTypeId"
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_ManageTypeId = "ManageTypeId";    //ManageTypeId
...
/// </summary>
 ...
 _CurrTabName = "QxUserGroupRelation";
...
else if (strAttributeName  ==  con_ManageId)
{
return mstrManageId;
}
else if (strAttributeName  ==  con_ManageTypeId)
{
...
mstrManageId = value.ToString();
 AddUpdatedFld(con_ManageId);
}
else if (strAttributeName  ==  con_ManageTypeId)
{
mstrManageTypeId = value.ToString();
 AddUpdatedFld(con_ManageTypeId);
}
else if (strAttributeName  ==  con_IsDefault)
{
...
else if (con_ManageId  ==  AttributeName[intIndex])
{
return mstrManageId;
}
else if (con_ManageTypeId  ==  AttributeName[intIndex])
{
return mstrManageTypeId;
}
