 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxUserDownLoadDetailLogExWApi
 表名:QxUserDownLoadDetailLog(00140059)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:10
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsQxUserDownLoadDetailLogExWApi
{
private static readonly string mstrApiControllerName = "QxUserDownLoadDetailLogExApi";
 /// <summary>
