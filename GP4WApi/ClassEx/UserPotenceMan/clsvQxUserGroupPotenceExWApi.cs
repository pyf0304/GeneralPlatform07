 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxUserGroupPotenceExWApi
 表名:vQxUserGroupPotence(00140022)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:23:48
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxUserGroupPotenceExWApi
{
private static readonly string mstrApiControllerName = "vQxUserGroupPotenceExApi";
 /// <summary>
