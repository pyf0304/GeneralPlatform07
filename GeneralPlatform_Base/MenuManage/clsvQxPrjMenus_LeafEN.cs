...
{
 /// <summary>
 /// 表vQxPrjMenus_Leaf的关键字(MenuId_Leaf)的类型定义. 以便检查类型以及操作方便.
 /// (AutoGCLib.EntityLayer4CSharp:GeneCode)
 /// </summary>
public struct K_MenuId_Leaf_vQxPrjMenus_Leaf
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
public K_MenuId_Leaf_vQxPrjMenus_Leaf(string strMenuId_Leaf)
{
if (IsValid(strMenuId_Leaf)) Value = strMenuId_Leaf;
else
{
Value = null;
}
}
private static bool IsValid(string strMenuId_Leaf)
{
if (string.IsNullOrEmpty(strMenuId_Leaf) == true) return false;
if (strMenuId_Leaf.Length != 8) return false;
return true;
}
/// <summary>
...
/// <param name="value">原类型表关键字</param>
 /// <returns>返回:[K_MenuId_Leaf_vQxPrjMenus_Leaf]类型的对象</returns>
public static implicit operator K_MenuId_Leaf_vQxPrjMenus_Leaf(string value)
{
return new K_MenuId_Leaf_vQxPrjMenus_Leaf(value);
}
}
 /// <summary>
...
{
public const string _CurrTabName_S = "vQxPrjMenus_Leaf"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "MenuId_Leaf"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 20;
public static string[] AttributeName = new string[] {"MenuId_Leaf", "MenuName", "QxPrjId", "PrjName", "UpMenuId", "LinkFile", "qsParameters", "ImgFile", "OrderNum", "IsLeafNode", "MenuSetId", "MenuSetName", "MenuTitle", "PageDispModeId", "PageDispModeName", "InUse", "UpdDate", "UpdUserId", "Memo", "MenuControlName"};
//以下是属性变量

protected string mstrMenuId_Leaf;    //MenuId_Leaf
...
protected string mstrMenuControlName;    //MenuControlName
 ...
 /// </summary>
 public const string con_MenuId_Leaf = "MenuId_Leaf";    //MenuId_Leaf
...
/// </summary>
 ...
 _CurrTabName = "vQxPrjMenus_Leaf";
 lstKeyFldNames.Add("MenuId_Leaf");
 }
...
/// </summary>
/// <param name = "strMenuId_Leaf">关键字:MenuId_Leaf</param>
public clsvQxPrjMenus_LeafEN(string strMenuId_Leaf)
 {
strMenuId_Leaf = strMenuId_Leaf.Replace("'", "''");
if (strMenuId_Leaf.Length > 8)
{
throw new Exception("在表:vQxPrjMenus_Leaf中,关键字长度不正确!");
}
if (string.IsNullOrEmpty(strMenuId_Leaf)  ==  true)
{
throw new Exception("在表:vQxPrjMenus_Leaf中,关键字不能为空 或 null!");
}
try
{
clsCheckSql.CheckStrSQL_Weak(strMenuId_Leaf);
}
...
this.mstrMenuId_Leaf = strMenuId_Leaf;
 SetInit();
 mbolIsCheckProperty = false;
 _CurrTabName = "vQxPrjMenus_Leaf";
 lstKeyFldNames.Add("MenuId_Leaf");
...
get
{
if (strAttributeName  ==  con_MenuId_Leaf)
{
...
if (strAttributeName  ==  con_MenuId_Leaf)
{
mstrMenuId_Leaf = value.ToString();
 AddUpdatedFld(con_MenuId_Leaf);
}
else if (strAttributeName  ==  con_MenuName)
{
...
get
{
if (con_MenuId_Leaf  ==  AttributeName[intIndex])
{
return mstrMenuId_Leaf;
}
