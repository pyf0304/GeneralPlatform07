 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPrjUserRelation4SynchExWApi
 表名:vQxPrjUserRelation4Synch(00140094)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:29
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxPrjUserRelation4SynchExWApi
{
private static readonly string mstrApiControllerName = "vQxPrjUserRelation4SynchExApi";
 /// <summary>
