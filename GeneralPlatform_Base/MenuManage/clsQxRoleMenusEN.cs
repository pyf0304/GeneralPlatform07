...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_mId_QxRoleMenus
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "QxRoleMenus"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 8;
public static string[] AttributeName = new string[] {"mId", "RoleId", "QxPrjId", "MenuId", "IsDisp", "UpdDate", "UpdUserId", "Memo"};
//以下是属性变量
