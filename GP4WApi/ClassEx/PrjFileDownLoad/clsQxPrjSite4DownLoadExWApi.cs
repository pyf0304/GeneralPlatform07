 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxPrjSite4DownLoadExWApi
 表名:QxPrjSite4DownLoad(00140055)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:07
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsQxPrjSite4DownLoadExWApi
{
private static readonly string mstrApiControllerName = "QxPrjSite4DownLoadExApi";
 /// <summary>
