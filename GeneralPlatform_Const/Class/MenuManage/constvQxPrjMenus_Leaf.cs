 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxPrjMenus_Leaf
 表名:vQxPrjMenus_Leaf
 生成代码版本:2018.04.19.1
 生成日期:2018/04/22 10:58:20
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPrjMenus_Leaf
{
public const string CurrTabName_S = "vQxPrjMenus_Leaf"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "MenuId_Leaf"; //当前表中的关键字名称,与该类相关的表中关键字名
...
//以下是属性变量
 ...
 /// </summary>
 public const string MenuId_Leaf = "MenuId_Leaf";    //MenuId_Leaf
