 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCommFun4WA4QxPrjMenus
 表名:QxPrjMenus(00140004)
 生成代码版本:2021.07.30.1
 生成日期:2021/07/30 00:50:28
 生成者:pyf
...
clsvQxPrjMenusWApi.ReFreshThisCache();
clsvQxPrjMenus_SubWApi.ReFreshThisCache();
clsvQxPrjMenus_UpWApi.ReFreshThisCache();
clsvQxPrjMenus_LeafWApi.ReFreshThisCache();
}
}
}