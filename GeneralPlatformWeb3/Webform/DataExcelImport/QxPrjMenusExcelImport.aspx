<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QxPrjMenusExcelImport.aspx.cs" Inherits="GeneralPlatform.DataExcelImport.QxPrjMenusExcelImport"  %>
                        ...
                        <table id="tabLayout" style="width: 100%;" border="0" runat="server" class="msgtable">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table id="tabQxPrjMenusGridView" style="width: 100%" class="msgtable"
                                        runat="server">
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvQxPrjMenus" Style="z-index: 117;" runat="server"
                                                    Width="100%" AutoGenerateColumns="False"
                                                    PageSize="10" AllowPaging="true"
                                                    AllowSorting="true"
                                                    OnSorting="gvQxPrjMenus_Sorting"
                                                    OnPageIndexChanging="gvQxPrjMenus_PageIndexChanging"
                                                    OnRowDeleting="gvQxPrjMenus_RowDeleting"
                                                    BackColor="White"
                                                    BorderColor="#E7E7FF"
                                                    BorderStyle="None"
                                                    BorderWidth="1px"
