...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_mId_QxUserMenus
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "QxUserMenus"; //当前表名,与该类相关的表名
...
protected string mstrMemo;    //备注
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_IsUseRoleMenu = "IsUseRoleMenu";    //是否使用角色菜单
...
else if (strAttributeName  ==  con_IsUseRoleMenu)
{
...
mbolIsUseRoleMenu = TransNullToBool(value.ToString());
 AddUpdatedFld(con_IsUseRoleMenu);
}
else if (strAttributeName  ==  con_Memo)
{
...
else if (con_IsUseRoleMenu  ==  AttributeName[intIndex])
{
return mbolIsUseRoleMenu;
}
