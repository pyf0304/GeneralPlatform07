namespace GeneralPlatform.Webform
{
    ...
    /// <summary>
    ///		wucRelaOfPotenceAndSymbol 的摘要说明。
    /// </summary>
    public partial class wucRelaOfPotenceAndSymbol : System.Web.UI.UserControl
	{
		...
		public void BindDdl_PotenceId(System.Web.UI.WebControls.DropDownList objDDL)
		{
			...
			System.Data.DataTable objDT = GetPotenceId(this.ddlPrjId.SelectedValue);
        ...
        //{
        //    BindDdl_PotenceId(ddlPotenceId);
        //}
		...
		protected void ddlPrjId_SelectedIndexChanged(object sender, System.EventArgs e)
		{
            ...
            if (ddlPrjId.SelectedIndex > 0)
            {
                ...
                this.SetDdl_PotenceTypeId(strPrjId);
            }
		}
        ...
        protected void ddlPotenceTypeId_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlPotenceTypeId.SelectedIndex > 0)
            {
                ...
                clsDropDownList.BindDdl_PotenceIdByType(ddlPotenceId, strPotenceTypeId);
            }
        }
}
