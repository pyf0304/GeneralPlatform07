 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvExportExcelSetEN_Sim
 表名:vExportExcelSet
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:39:08
 生成者:潘以锋
...
public class clsvExportExcelSetEN_Sim 
{
//以下是属性变量

private string mstrid_ExportExcel4Users;    //导出Excel用户字段流水号
private string mstrViewName;    //界面名称
private string mstrTabName;    //TabName
private bool mbolIsDefaultUser;    //是否缺省用户
private string mstrUserName;    //用户名
private string mstrExportFileName;    //导出文件名
...
private string mstrViewTabName;    //ViewTabName
