...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_FuncModuleAgcId_vQxFuncModule_Agc
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "vQxFuncModule_Agc"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "FuncModuleAgcId"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 12;
public static string[] AttributeName = new string[] {"PrjName", "UseStateName", "FuncModuleAgcId", "FuncModuleName", "FuncModuleEnName", "FuncModuleName_Sim", "QxPrjId", "OrderNum", "UseStateId", "UpdUser", "UpdDate", "Memo"};
//以下是属性变量
...
/// </summary>
 ...
 _CurrTabName = "vQxFuncModule_Agc";
...
get
{
if (strAttributeName  ==  con_PrjName)
{
return mstrPrjName;
}
...
get
{
if (con_PrjName  ==  AttributeName[intIndex])
{
return mstrPrjName;
}
