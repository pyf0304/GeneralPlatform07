        ...
        <tr>
                        ...
                        <td style="width: 398px">
                            <table id="Table1" cellspacing="0" cellpadding="0" width="390" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="lbCollapse" runat="server" CssClass="LinkButton_Defa" OnClick="lbCollapse_Click">收起一层</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <td valign="top" rowspan="2">
                <table id="Table4" cellspacing="0" cellpadding="0" width="300" border="0">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="btnOKUpd" runat="server" CssClass="Button_Defa"  Text="添加" OnClick="btnOKUpd_Click">
                            </asp:Button>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <tr>
                        <td align="center">
                            <asp:Button ID="lbHideRef" runat="server" CssClass="Button_Defa"  Text="隐藏参考" OnClick="lbHideRef_Click">
                            </asp:Button>
                        </td>
                    </tr>
                </table>
