...
/// 静态类
/// </summary>
public static class  clsQxPotenceTypeWApi_Static
{
...
try
{
objQxPotenceTypeEN.sfUpdFldSetStr = objQxPotenceTypeEN.getsfUpdFldSetStr();
clsQxPotenceTypeWApi.CheckPropertyNew(objQxPotenceTypeEN); 
bool bolResult = clsQxPotenceTypeWApi.UpdateRecord(objQxPotenceTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxPotenceTypeEN objQxPotenceTypeEN)
{
//检测记录是否存在
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsQxPotenceTypeWApi.IsExist(objQxPotenceTypeEN.PotenceTypeId) == true)
 {
...
{
clsQxPotenceTypeWApi.CheckPropertyNew(objQxPotenceTypeEN); 
bool bolResult = clsQxPotenceTypeWApi.AddNewRecord(objQxPotenceTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshCache();
return bolResult;
}
...
{
clsQxPotenceTypeWApi.CheckPropertyNew(objQxPotenceTypeEN); 
string strPotenceTypeId = clsQxPotenceTypeWApi.AddNewRecordWithMaxId(objQxPotenceTypeEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshCache();
...
{
clsQxPotenceTypeWApi.CheckPropertyNew(objQxPotenceTypeEN); 
bool bolResult = clsQxPotenceTypeWApi.UpdateWithCondition(objQxPotenceTypeEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxPotenceTypeWApi
{
private static readonly string mstrApiControllerName = "QxPotenceTypeApi";
...
{
//为数据源为表的下拉框设置内容
string strCondition = string.Format("1 =1 Order By {0}", conQxPotenceType.PotenceTypeId); 
List<clsQxPotenceTypeEN> arrObjLst = clsQxPotenceTypeWApi.GetObjLst(strCondition);
//初始化一个对象列表
//插入第0项。在第0项中插入“请选择...”,为了方便用户,与WEB方式类似。
clsQxPotenceTypeEN objQxPotenceTypeEN = new clsQxPotenceTypeEN()
{
PotenceTypeId = "0",
PotenceTypeName = "选[权限类型]..."
};
arrObjLst.Insert(0, objQxPotenceTypeEN);
//设置下拉框的数据源、以及设置值项、显示项
objComboBox.ValueMember = conQxPotenceType.PotenceTypeId;
objComboBox.DisplayMember = conQxPotenceType.PotenceTypeName;
...
if (!Object.Equals(null, objQxPotenceTypeEN.UpdDate) && GetStrLen(objQxPotenceTypeEN.UpdDate) > 20)
{
 throw new Exception("字段[修改日期]的长度不能超过20!");
}
if (!Object.Equals(null, objQxPotenceTypeEN.UpdUserId) && GetStrLen(objQxPotenceTypeEN.UpdUserId) > 20)
{
...
clsQxPotenceTypeEN objQxPotenceTypeEN;
...
objQxPotenceTypeEN = JsonConvert.DeserializeObject<clsQxPotenceTypeEN>(strJson);
return objQxPotenceTypeEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxPotenceTypeEN GetFirstObj(string strWhereCond)
{
...
from objQxPotenceTypeEN in arrQxPotenceTypeObjLstCache
where objQxPotenceTypeEN.PotenceTypeId == strPotenceTypeId 
select objQxPotenceTypeEN;
if (arrQxPotenceTypeObjLst_Sel.Count() == 0)
{
   clsQxPotenceTypeEN obj = clsQxPotenceTypeWApi.GetObjByPotenceTypeId(strPotenceTypeId);
   if (obj != null)
 {
...
//初始化列表缓存
List<clsQxPotenceTypeEN> arrQxPotenceTypeObjLstCache = GetObjLstCache();
IEnumerable <clsQxPotenceTypeEN> arrQxPotenceTypeObjLst_Sel1 =
from objQxPotenceTypeEN in arrQxPotenceTypeObjLstCache
where objQxPotenceTypeEN.PotenceTypeId == strPotenceTypeId 
select objQxPotenceTypeEN;
List <clsQxPotenceTypeEN> arrQxPotenceTypeObjLst_Sel = new List<clsQxPotenceTypeEN>();
foreach (clsQxPotenceTypeEN obj in arrQxPotenceTypeObjLst_Sel1)
{
arrQxPotenceTypeObjLst_Sel.Add(obj);
}
if (arrQxPotenceTypeObjLst_Sel.Count > 0)
{
return arrQxPotenceTypeObjLst_Sel[0].PotenceTypeName;
}
string strErrMsgForGetObjById = string.Format("在QxPotenceType对象缓存列表中,找不到记录[PotenceTypeId = {0}](函数:{1})", strPotenceTypeId, clsStackTrace.GetCurrFunction());
...
string strErrMsgForGetObjById = string.Format("在QxPotenceType对象缓存列表中,找不到记录的相关名称[PotenceTypeId = {0}](函数:{1})", strPotenceTypeId, clsStackTrace.GetCurrFunction());
clsLog.LogErrorS2("clsQxPotenceTypeBL", clsStackTrace.GetCurrClassFunction(), strErrMsgForGetObjById, "", "");
throw new Exception(strErrMsgForGetObjById);
}
...
{
 List<clsQxPotenceTypeEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxPotenceTypeEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxPotenceTypeEN> GetObjLstByPotenceTypeIdLst(List<string> arrPotenceTypeId)
{
 List<clsQxPotenceTypeEN> arrObjLst; 
...
public static IEnumerable<clsQxPotenceTypeEN> GetObjLstByPotenceTypeIdLstCache(List<string> arrPotenceTypeId)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsQxPotenceTypeEN._CurrTabName);
List<clsQxPotenceTypeEN> arrQxPotenceTypeObjLstCache = GetObjLstCache();
IEnumerable <clsQxPotenceTypeEN> arrQxPotenceTypeObjLst_Sel =
from objQxPotenceTypeEN in arrQxPotenceTypeObjLstCache
where arrPotenceTypeId.Contains(objQxPotenceTypeEN.PotenceTypeId)
select objQxPotenceTypeEN;
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxPotenceTypeEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxPotenceTypeEN> arrObjLst; 
...
try
{
 clsQxPotenceTypeEN objQxPotenceTypeEN = clsQxPotenceTypeWApi.GetObjByPotenceTypeId(strPotenceTypeId);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strPotenceTypeId.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxPotenceTypes(List<string> arrPotenceTypeId)
{
string strAction = "DelQxPotenceTypes";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrPotenceTypeId);
...
{
string strAction = "DelQxPotenceTypesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxPotenceTypeEN objQxPotenceTypeEN)
{
...
public static string AddNewRecordWithMaxId(clsQxPotenceTypeEN objQxPotenceTypeEN)
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshCache();
var strPotenceTypeId = (string)jobjReturn0["returnStr"];
return strPotenceTypeId;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxPotenceTypeEN objQxPotenceTypeEN)
{
if (string.IsNullOrEmpty(objQxPotenceTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxPotenceTypeEN.PotenceTypeId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxPotenceTypeEN objQxPotenceTypeEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxPotenceTypeEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxPotenceTypeEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxPotenceTypeEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxPotenceTypeEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxPotenceTypeEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxPotenceTypeEN objInFor in arrObj)
{
//Rows
...
if (clsQxPotenceTypeWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxPotenceTypeEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxPotenceTypeWApi.objCommFun4WApi.ReFreshCache();
}
}
...
var strKey = clsQxPotenceTypeEN._CurrTabName;
List<clsQxPotenceTypeEN> arrQxPotenceTypeObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsQxPotenceTypeEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxPotenceType.PotenceTypeId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.PotenceTypeName, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.QxPrjId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.FuncModuleId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.MenuId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.ViewId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.IsVisible, Type.GetType("System.Boolean"));
objDT.Columns.Add(conQxPotenceType.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.UpdUserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxPotenceType.Memo, Type.GetType("System.String"));
foreach (clsQxPotenceTypeEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxPotenceType.PotenceTypeId] = objInFor[conQxPotenceType.PotenceTypeId];
objDR[conQxPotenceType.PotenceTypeName] = objInFor[conQxPotenceType.PotenceTypeName];
objDR[conQxPotenceType.QxPrjId] = objInFor[conQxPotenceType.QxPrjId];
objDR[conQxPotenceType.FuncModuleId] = objInFor[conQxPotenceType.FuncModuleId];
objDR[conQxPotenceType.MenuId] = objInFor[conQxPotenceType.MenuId];
objDR[conQxPotenceType.ViewId] = objInFor[conQxPotenceType.ViewId];
objDR[conQxPotenceType.IsVisible] = objInFor[conQxPotenceType.IsVisible];
objDR[conQxPotenceType.UpdDate] = objInFor[conQxPotenceType.UpdDate];
objDR[conQxPotenceType.UpdUserId] = objInFor[conQxPotenceType.UpdUserId];
objDR[conQxPotenceType.Memo] = objInFor[conQxPotenceType.Memo];
...
return objDT;
 ...
 /// </summary>
public class  clsCommFun4WA4QxPotenceType : clsCommFun4BL
{
...
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxPotenceTypeWApi.ReFreshThisCache();
}
}
