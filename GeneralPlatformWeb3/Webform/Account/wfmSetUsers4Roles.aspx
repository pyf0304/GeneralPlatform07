<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="GeneralPlatform.Webform.wfmSetUsers4Roles" CodeBehind="wfmSetUsers4Roles.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <table id="tabLayout"
            cellspacing="2" cellpadding="2" border="0" runat="server" class="auto-style1">
            <tr>
                                    ...
                                    <ul class="UlBanner">
                                        ...
                                        <li>
                                            <asp:Label ID="lblDepartmentId_q" runat="server" CssClass="NameLabel"
                                                Style="z-index: 102;" Width="30px">部门</asp:Label>
                                        </li>
            ...
            <tr>
                <td valign="top">
                    <table id="tabUsersGridView" runat="server" class="auto-style2">
                        <tr>
                            <td>
                                <div style="width: 100%;">
                                    <ul class="UlBanner">
                                        ...
                                        <li align="right">
                                            <asp:Button ID="btnAddNewRec4Gv" runat="server" CssClass="auto-style3" OnClick="btnAddNewRec4Gv_Click" Text="添加所选用户" Width="125px" />
                                        </li>
                                </div>
                            </td>
                        </tr>
