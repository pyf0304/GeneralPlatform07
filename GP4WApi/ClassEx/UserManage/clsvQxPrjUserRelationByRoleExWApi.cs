 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPrjUserRelationByRoleExWApi
 表名:vQxPrjUserRelationByRole(00140076)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:19
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxPrjUserRelationByRoleExWApi
{
private static readonly string mstrApiControllerName = "vQxPrjUserRelationByRoleExApi";
 /// <summary>
