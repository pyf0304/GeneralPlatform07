...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
 {
["objQxViewInfoEN"] = clsQxViewInfoBL.SerializeObjToXMLStr(objQxViewInfoEN)
 };
...
return bolResult;
 ...
 /// <returns>表对象</returns>
[WebMethod]
public clsQxViewInfoEN QxViewInfo_GetObjByViewId(string strViewId)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
[WebMethod]
public List<clsQxViewInfoEN> QxViewInfo_GetObjLst(string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
return arrQxViewInfoObjLst;
 ...
 /// <returns>返回对象列表</returns>
[WebMethod]
public List<clsQxViewInfoEN> QxViewInfo_GetTopObjLst(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
List<clsQxViewInfoEN> arrQxViewInfoObjLst = clsQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
return arrQxViewInfoObjLst;
}
...
[WebMethod]
public clsQxViewInfoEN QxViewInfo_GetFirstObj_S(string strWhereCond) 
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objQxViewInfoEN = clsQxViewInfoBL.GetObjByViewId(strViewId);
 if (objQxViewInfoEN == null) return "";
 }
 catch (Exception objException)
 {
string strMsg = "根据关键字获取对象出错!(QxViewInfoService:GetJSONObjByViewId)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 objQxViewInfoEN = clsQxViewInfoBL.GetFirstObj_S(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取第一条记录的对象出错!(QxViewInfoService:GetFirstJSONObj)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObj<clsQxViewInfoEN>(objQxViewInfoEN);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxViewInfoObjLst = clsQxViewInfoBL.GetObjLst(strWhereCond);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(QxViewInfoService:GetJSONObjLst)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxViewInfoObjLst);
 return strJSON;
 }
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxViewInfoObjLst = clsQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取的对象列表出错!(QxViewInfoService:GetJSONObjLst)\r\n" + objException.Message;
...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strQxViewInfoJSONObj"] = strQxViewInfoJSONObj
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 try
 {
clsQxViewInfoEN objQxViewInfoEN = clsJSON.GetObjFromJson<clsQxViewInfoEN>(strQxViewInfoJSONObj);
bool bolResult = objQxViewInfoEN.AddNewRecord();
return bolResult;
 }
 catch (Exception objException)
 {
string strMsg = "通过JSON对象来添加记录对象出错!(QxViewInfoService:QxViewInfo_AddNewRecordBySql2ByJSON)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
}
...
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strQxViewInfoObjXml"] = strQxViewInfoObjXml
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
bool bolResult = clsQxViewInfoBL.AddNewRecordBySql_XML(strQxViewInfoObjXml);
return bolResult;
}
...
return bolResult;
 ...
 {
string strMsg = "通过JSON对象来修改记录对象出错!(QxViewInfoService:QxViewInfo_UpdateBySql2ByJSON)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
}
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
bool bolResult = clsQxViewInfoBL.UpdateBySql_XML(strQxViewInfoObjXml);
return bolResult;
}
...
{
List<string> arrViewId = clsJSON.GetObjLstFromJson<string>(strJSON4Keys);
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["arrViewId"] = clsArray.GetSqlInStrByArray(arrViewId, true)
 };
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
int intRecNum = clsQxViewInfoBL.DelQxViewInfos(arrViewId);
return intRecNum;
}
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsQxViewInfoEN> lstQxViewInfoObjLst = clsQxViewInfoBL.GetObjLst(strWhereCond);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsQxViewInfoBL.SerializeObjLstToXMLStr(lstQxViewInfoObjLst);
}
catch (Exception objException)
{
clsPubVar_WS.objLog.WriteDebugLog(objException.Message);
...
return strXmlString;
 ...
 /// <returns>返回一个<clsQxViewInfoEN>对象列表XML串</returns>
[WebMethod]
public string QxViewInfo_SerializeTopObjLstToXMLStr(int intTopSize, string strWhereCond, string strOrderBy = "")
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string strXmlString = "";
List<clsQxViewInfoEN> lstQxViewInfoObjLst = clsQxViewInfoBL.GetTopObjLst(intTopSize, strWhereCond, strOrderBy);
try
{
clsPubVar_WS.objLog.WriteDebugLog("XML输出文件:" + clsSysParaEN.strTempXMLFileName + clsDateTime.getTodayDateTimeStr(0));
strXmlString = clsQxViewInfoBL.SerializeObjLstToXMLStr(lstQxViewInfoObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxViewInfoObjLst = clsQxViewInfoBL.GetObjLstByPager(intPageIndex, intPageSize, strWhereCond, strOrderBy);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件分页获取的对象列表出错!(QxViewInfoService:GetJSONObjLstByPager)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxViewInfoObjLst);
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
string[] sstrViewId = strKeyIdLst.Trim().Split(',');
List <string> arrViewId = new List<string>();
foreach (string strViewId in sstrViewId)
{
if (string.IsNullOrEmpty(strViewId) == false)
{
arrViewId.Add(strViewId);
}
}
int intRecNum = clsQxViewInfoBL.DelQxViewInfos(arrViewId);
return intRecNum;
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
 ...
 try
 {
 arrQxViewInfoObjLst = clsQxViewInfoBL.GetObjLstByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
 }
 catch (Exception objException)
 {
string strMsg = "根据条件获取指定范围内的对象列表出错!(QxViewInfoService:GetJSONObjLstByRange)\r\n" + objException.Message;
clsPubVar_WS.objLog.WriteDebugLog(strMsg);
 throw new Exception(strMsg);
 }
 string strJSON = clsJSON.GetJsonFromObjLst(arrQxViewInfoObjLst);
 ...
 [WebMethod]
 public List<clsQxViewInfoEN> GetObjLstByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
 {
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxViewInfoBL.GetDataSet(strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet QxViewInfo_GetTopDataSet(int intTopSize, string strWhereCond)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxViewInfoBL.GetDataSet_Top(intTopSize, strWhereCond);
return objDS;
}
 ...
 /// <returns>返回数据集,用DataSet表示</returns>
[WebMethod]
public DataSet QxViewInfo_GetDataSetByRange(string strWhereCond, string strOrderBy, int intMinNum, int intMaxNum)
{
string strFunctionName = clsStackTrace.GetCurrFunction();
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
...
clsPubFun_WS.Log4Debug(this, strFunctionName, dictParam);
DataSet objDS = clsQxViewInfoBL.GetDataSetByRange(strWhereCond, strOrderBy, intMinNum, intMaxNum);
return objDS;
}
}
}