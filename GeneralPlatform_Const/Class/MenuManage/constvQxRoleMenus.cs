...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxRoleMenus
{
public const string CurrTabName_S = "vQxRoleMenus"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"mId", "RoleId", "RoleName", "QxPrjId", "MenuId", "MenuName", "PrjName", "UpMenuId", "LinkFile", "qsParameters", "ImgFile", "OrderNum", "IsLeafNode", "MenuSetId", "MenuSetName", "MenuTitle", "PageDispModeId", "PageDispModeName", "InUse", "UpMenuName", "UpdDate", "UpdUserId", "Memo"};
//以下是属性变量
