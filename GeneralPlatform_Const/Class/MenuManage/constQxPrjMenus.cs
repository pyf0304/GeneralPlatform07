...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constQxPrjMenus
{
public const string CurrTabName_S = "QxPrjMenus"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "MenuId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"MenuId", "MenuName", "QxPrjId", "UpMenuId", "LinkFile", "qsParameters", "ImgFile", "RoleId", "OrderNum", "IsLeafNode", "MenuSetId", "MenuTitle", "PageDispModeId", "InUse", "UpdDate", "UpdUserId", "Memo", "MenuControlName"};
//以下是属性变量
