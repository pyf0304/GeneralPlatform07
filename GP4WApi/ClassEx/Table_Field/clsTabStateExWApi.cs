...
namespace GP4WApi
{
public static class clsTabStateExWApi_Static
{
...
clsTabStateWApi.CopyTo(objTabStateENS, objTabStateENT);
...
public static bool EditRecordEx(this clsTabStateEN objTabStateEN)
{
...
try
{
bool bolResult = clsTabStateExWApi.EditRecordEx(objTabStateEN);
...
public static bool EditRecordEx(clsTabStateEN objTabStateEN)
{
