<%@ Register TagPrefix="uc1" TagName="wucQxUserRoleRelationB" Src="wucQxUserRoleRelationB.ascx" %>
<%@ Register TagPrefix="uc2" TagName="wucvQxUserRoleRelation4Gv" Src="wucvQxUserRoleRelation4Gv.ascx" %>

<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmQxUserRoleRelationB_QUDI.aspx.cs" Inherits="GeneralPlatform.Webform.wfmQxUserRoleRelationB_QUDI" %>
    ...
    <form id="form1" runat="server">
        <div id="tabLayout" class="tab_layout"
            ...
            <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                <asp:Label ID="lblViewTitle" runat="server" CssClass="PageTitleH1" Height="16px">用户角色关系维护
                </asp:Label>
            ...
            <div id="divQuery" class="div_query">
                <table class="msgtable" style="width: 80%">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlUserId_q" Style="z-index: 105;"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblIdentityID_q" Style="z-index: 116;"
                                runat="server" CssClass="NameLabel">身份编号</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtIdentityID_q" Style="z-index: 117;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:TextBox>
                        </td>

                        <td>
                            <asp:Label ID="lblRoleId_q" Style="z-index: 119;"
                                runat="server" CssClass="NameLabel">角色Id</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlRoleId_q" Style="z-index: 120;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>

                        <td>
                            <asp:Label ID="lblQxPrjId_q" Style="z-index: 122;"
                                runat="server" CssClass="NameLabel">项目Id</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlQxPrjId_q" Style="z-index: 123;"
                                runat="server" CssClass="TextBox_Defa">
                            </asp:DropDownList>
                        </td>
                        <td>
                            ...
                            <asp:Button ID="btnQuery"
                                Style="z-index: 125; width: 80px; height: 24px;"
                                runat="server"
            ...
            <div id="divFunction" class="div_Funttion" runat="server">
                <table id="tabGridFunction" style="width: 100%; height: 32px;" class="msgtable">
                    <tr>
                        <td>
                            <asp:Label ID="lblQxUserRoleRelationList" Style="z-index: 105;" CssClass="RegionTitleH1" Width="250px" Text="用户角色关系列表" runat="server" />
                        </td>
                        <td>
            ...
            <div id="divList" class="div_List" runat="server">
                <uc2:wucvQxUserRoleRelation4Gv runat="server" ID="wucvQxUserRoleRelation4Gv1"
                    OnGvUpdateClick="wucvQxUserRoleRelation4Gv1_GvUpdateClick"
                    OnGvDeleteClick="wucvQxUserRoleRelation4Gv1_GvDeleteClick" />
            </div>
            <%-- 编辑层 --%>
            <div id="tabEditQxUserRoleRelationRegion" class="tab_Edit"
                runat="server">
                <div>
                    <table style="width: 100%;" class="msgtable">
                        <tr>
                            <th style="text-align: left">
                                <asp:Label ID="lblEditQxUserRoleRelation" Style="z-index: 104;" runat="server"
                                    CssClass="RegionTitleH1">用户角色关系编辑区域</asp:Label>
                            ...
                            <th style="text-align: right">
                                ...
                                <asp:Button ID="btnCancelQxUserRoleRelationEdit" Style="z-index: 107;"
                                    runat="server" Width="100px" CssClass="btn btn-outline-info btn-sm" Text="取消编辑" OnClick="btnCancelQxUserRoleRelationEdit_Click"></asp:Button>
                            </th>
                        </tr>
                    </table>
                </div>
                <div>
                    <uc1:wucQxUserRoleRelationB ID="wucQxUserRoleRelationB1" runat="server" />
                </div>
            </div>
        </div>
    </form>
