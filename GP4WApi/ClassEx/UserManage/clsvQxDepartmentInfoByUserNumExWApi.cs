 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxDepartmentInfoByUserNumExWApi
 表名:vQxDepartmentInfoByUserNum(00140082)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:22
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxDepartmentInfoByUserNumExWApi
{
private static readonly string mstrApiControllerName = "vQxDepartmentInfoByUserNumExApi";
 /// <summary>
