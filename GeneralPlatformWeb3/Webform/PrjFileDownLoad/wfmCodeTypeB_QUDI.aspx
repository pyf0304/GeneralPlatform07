...
<%@ Page Language="c#" AutoEventWireup="True" CodeBehind="wfmCodeTypeB_QUDI.aspx.cs" 
    Inherits="GeneralPlatform.Webform.wfmCodeTypeB_QUDI" Theme="TaiZeTheme" %>
        ...
        <table id="tabLayout" style="z-index: 105; left: 0px; position: absolute; top: 0px" cellspacing="2"
            ...
            <tr>
                <td>
                    ...
                    <div style="position: relative; width: 648px; height: 37px; left: 0px; top: 0px;">
                        <asp:Label ID="lblViewTitle" runat="server" CssClass="PageTitleH1">代码类型维护
                        </asp:Label>
                ...
                <td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblCodeTypeId_q" Style="z-index: 104;"
                                    runat="server" Width="90px" Height="20px" CssClass="NameLabel">代码类型Id</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCodeTypeId_q" Style="z-index: 105;"
                                    runat="server" Width="100px" Height="22px" CssClass="TextBox_Defa">
                                </asp:TextBox>
                            </td>

                            <td>
                                <asp:Label ID="lblCodeTypeName_q" Style="z-index: 107;"
                                    runat="server" Width="90px" Height="20px" CssClass="NameLabel">代码类型名</asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCodeTypeName_q" Style="z-index: 108;"
                                    runat="server" Width="100px" Height="22px" CssClass="TextBox_Defa">
                                </asp:TextBox>
                            </td>
                        </tr>
            ...
            <tr>
                <td>
                    ...
                    <table id="tabCodeTypeGridView" style="width: 100%"
                        runat="server">
                        <tr>
                            <td>
                                <table style="width: 100%; height: 32px" id="tabGridFunction">
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCodeTypeList" runat="server" Style="z-index: 105;"
                                                CssClass="RegionTitleH1" Width="250px">代码类型列表</asp:Label>
                                        </td>
                                        <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvCodeType" Style="z-index: 111;" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="QxCodeTypeId" SortExpression="QxCodeTypeId" HeaderText="代码类型Id"></asp:BoundField>
            ...
            <tr>
                <td>
                    <table id="tabEditCodeTypeRegion" style="z-index: 111; width: 100%"
                        cellspacing="1" cellpadding="1" width="100%" border="1" runat="server">
                        <tr>
                            <td>
                                <asp:Label ID="lblEditCodeType" Style="z-index: 104;" runat="server"
                                    CssClass="RegionTitleH1">代码类型编辑区域</asp:Label>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Button ID="btnCancelCodeTypeEdit" Style="z-index: 107;"
