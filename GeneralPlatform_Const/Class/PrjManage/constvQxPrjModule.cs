 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxPrjModule
 表名:vQxPrjModule
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:39:45
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPrjModule
{
public const string CurrTabName_S = "vQxPrjModule"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "ModuleId"; //当前表中的关键字名称,与该类相关的表中关键字名
