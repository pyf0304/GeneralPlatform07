 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPrjSite4DownLoadExWApi
 表名:vQxPrjSite4DownLoad(00140061)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:11
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxPrjSite4DownLoadExWApi
{
private static readonly string mstrApiControllerName = "vQxPrjSite4DownLoadExApi";
 /// <summary>
