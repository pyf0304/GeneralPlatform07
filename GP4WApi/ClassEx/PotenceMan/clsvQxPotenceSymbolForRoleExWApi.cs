 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPotenceSymbolForRoleExWApi
 表名:vQxPotenceSymbolForRole(00140047)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:02
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxPotenceSymbolForRoleExWApi
{
private static readonly string mstrApiControllerName = "vQxPotenceSymbolForRoleExApi";
 /// <summary>
