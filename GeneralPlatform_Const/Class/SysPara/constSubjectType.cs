...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constSubjectType
{
public const string CurrTabName_S = "SubjectType"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "SubjectTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
