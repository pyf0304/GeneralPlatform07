<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="EduHigh.Webform.PersonalCenter.Index"
    Title="无标题页" %>
...
<%--<div class="navigation"><b>您当前的位置：首页 &gt; 控制中心 &gt; 控制中心首页</b></div>
...
<div style="text-align:center; color:Red; margin-top:20px;">
   <h2>
       欢迎进入<% =strSiteName %>——后台管理</h2>
 </div>
  <center>
      <%-- 上海s58362   南京s58238 --%>
	<iframe id=weather_map src=http://weather.china.com.cn/city/s58362_24.html width=130 height=100 border=0 frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no>
  </iframe>
  <iframe id=weather_map_48 src=http://weather.china.com.cn/city/s58362_48.html width=130 height=100 border=0 frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no>
  </iframe>
  <iframe id=weather_map_72 src=http://weather.china.com.cn/city/s58362_72.html width=130 height=100 border=0 frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no>
  </iframe>
	...
	<form target="_blank">
		...
		<tr  align="center"><td>
			<input type="button" id = "bd" value="百度一下" style="height:25;font-size:12pt;width:95" onclick="doA()">
			</td><td>
  ...
  <CENTER>
          ...
          <TR>
            <TD vAlign="top" align="middle">
              ...
              <P>
                ...
                <FONT id="tSave" style="FONT-SIZE: 18pt; COLOR: red; FONT-FAMILY: Wingdings"></FONT><BR><BR>
                <FONT style="FONT-SIZE: 120pt; COLOR: green; FONT-FAMILY: Webdings">&ucirc;</FONT><BR>
                <FONT id="CITY" style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '宋体'"></FONT>
              </P>
            </TD>
            <TD align="middle">
              <DIV style="Z-INDEX: -1; POSITION: absolute;">
                <FONT id="YMBG" style="FONT-SIZE: 95pt; COLOR: #f0f0f0; FONT-FAMILY: 'Arial Black'">&nbsp;0000<BR>&nbsp;JUN</FONT>
              </DIV>
              <TABLE border="0">
                <TBODY>
                  <TR>
    ...
    //-->
                      ...
                      <FONT id="GZ" face="宋体" color="#ffffff" size="2"></FONT><BR>
                    </TD>
                  </TR>
    ...
    for (i = 0; i < 6; i++) {
        ...
        document.write('</tr>');
            ...
            <TD vAlign="top" align="middle" width="60"><BR><BR><BR><BR>
              <BUTTON style="FONT-SIZE: 9pt" onClick="pushBtm('YU')">年↑</BUTTON><BR>
              <BUTTON style="FONT-SIZE: 9pt" onClick="pushBtm('YD')">年↓</BUTTON>
              <P>
                <BUTTON style="FONT-SIZE: 9pt" onclick="pushBtm('MU')">月↑</BUTTON><BR>
                <BUTTON style="FONT-SIZE: 9pt" onclick="pushBtm('MD')">月↓</BUTTON>
              </p>
                <P>
