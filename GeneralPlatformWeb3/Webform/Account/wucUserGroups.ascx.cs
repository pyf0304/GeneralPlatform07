...
namespace GeneralPlatform.Webform
{
    ...
    ///		wucUserGroups 的摘要说明。
    /// </summary>
    public partial class wucUserGroups : System.Web.UI.UserControl
	{
		...
		{
			txtGroupId.ReadOnly = bolReadonly;
		}
		public void Clear()
		{
			txtGroupId.Text = "";
		...
		{
			if(this.ddlPrjId.SelectedValue != "0")
			{
                 this.txtGroupId.Text = clsQxUserGroupsBL.GetMaxStrIdByPrefix_S(this.ddlPrjId.SelectedValue);
			}
			else
			{
