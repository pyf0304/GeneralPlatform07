 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxPrjMenus_SubEN_Sim
 表名:vQxPrjMenus_Sub
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 11:53:36
 生成者:潘以锋
...
public class clsvQxPrjMenus_SubEN_Sim 
{
//以下是属性变量

private string mstrMenuId_Sub;    //MenuId_Sub
private string mstrMenuName;    //菜单名
private string mstrQxPrjId;    //项目Id
private string mstrPrjName;    //工程名
private string mstrUpMenuId;    //上级菜单Id
private string mstrLinkFile;    //链接文件
private string mstrqsParameters;    //qs参数
private string mstrImgFile;    //图像文件
private int mintOrderNum;    //排序号
private bool mbolIsLeafNode;    //是否叶子
private string mstrMenuSetId;    //菜单集Id
private string mstrMenuSetName;    //菜单集名称
private string mstrMenuTitle;    //菜单标题
private string mstrPageDispModeId;    //页面显示模式Id
private string mstrPageDispModeName;    //页面显示模式名称
private bool mbolInUse;    //是否在用
private string mstrUpdDate;    //修改日期
private string mstrUpdUserId;    //修改用户Id
private string mstrMemo;    //备注
private string mstrMenuControlName;    //MenuControlName
