namespace GeneralPlatform.Webform
{
    ...
    /// <summary>
    ///		wucQxViewPotence 的摘要说明。
    /// </summary>
    public partial class wucQxViewPotence : System.Web.UI.UserControl
	{
		...
		public int Level
		{
			get
			{
				return int.Parse(txtLevel.Text.Trim());
			}
			set
			{
		...
		public bool IsValid()
		{
			ComValid_Level.Validate();
			if (!ComValid_Level.IsValid) return false;
			return true;
		}
		/// <summary>
		/// 设置该控件在插入状态下的缺省值
		...
		public void BindDdl_ViewId(System.Web.UI.WebControls.DropDownList objDDL)
		{
			...
			System.Data.DataTable objDT = GetViewId(this.ddlPrjId.SelectedValue);
