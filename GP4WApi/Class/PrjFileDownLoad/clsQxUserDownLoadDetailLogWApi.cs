...
/// 静态类
/// </summary>
public static class  clsQxUserDownLoadDetailLogWApi_Static
{
...
try
{
objQxUserDownLoadDetailLogEN.sfUpdFldSetStr = objQxUserDownLoadDetailLogEN.getsfUpdFldSetStr();
clsQxUserDownLoadDetailLogWApi.CheckPropertyNew(objQxUserDownLoadDetailLogEN); 
bool bolResult = clsQxUserDownLoadDetailLogWApi.UpdateRecord(objQxUserDownLoadDetailLogEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN)
{
//检测记录是否存在
...
{
clsQxUserDownLoadDetailLogWApi.CheckPropertyNew(objQxUserDownLoadDetailLogEN); 
bool bolResult = clsQxUserDownLoadDetailLogWApi.AddNewRecord(objQxUserDownLoadDetailLogEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserDownLoadDetailLogWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
{
clsQxUserDownLoadDetailLogWApi.CheckPropertyNew(objQxUserDownLoadDetailLogEN); 
bool bolResult = clsQxUserDownLoadDetailLogWApi.UpdateWithCondition(objQxUserDownLoadDetailLogEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserDownLoadDetailLogWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxUserDownLoadDetailLogWApi
{
private static readonly string mstrApiControllerName = "QxUserDownLoadDetailLogApi";
...
public static clsCommFun4BL objCommFun4WApi = null;
 ...
 public clsQxUserDownLoadDetailLogWApi()
 {
 }
...
clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN;
...
objQxUserDownLoadDetailLogEN = JsonConvert.DeserializeObject<clsQxUserDownLoadDetailLogEN>(strJson);
return objQxUserDownLoadDetailLogEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxUserDownLoadDetailLogEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsQxUserDownLoadDetailLogEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxUserDownLoadDetailLogEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxUserDownLoadDetailLogEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsQxUserDownLoadDetailLogEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxUserDownLoadDetailLogEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxUserDownLoadDetailLogEN> arrObjLst; 
...
try
{
 clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN = clsQxUserDownLoadDetailLogWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxUserDownLoadDetailLogs(List<string> arrmId)
{
string strAction = "DelQxUserDownLoadDetailLogs";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelQxUserDownLoadDetailLogsByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN)
{
...
public static string AddNewRecordWithReturnKey(clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN)
{
if (string.IsNullOrEmpty(objQxUserDownLoadDetailLogEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxUserDownLoadDetailLogEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxUserDownLoadDetailLogEN objQxUserDownLoadDetailLogEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxUserDownLoadDetailLogEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxUserDownLoadDetailLogEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxUserDownLoadDetailLogEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxUserDownLoadDetailLogEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxUserDownLoadDetailLogEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxUserDownLoadDetailLogEN objInFor in arrObj)
{
//Rows
...
if (clsQxUserDownLoadDetailLogWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxUserDownLoadDetailLogEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxUserDownLoadDetailLogWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsQxUserDownLoadDetailLogEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxUserDownLoadDetailLog.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.UserDownLoadLogId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.FileName, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.Version, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.IsSuccess, Type.GetType("System.Boolean"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.LogInfo, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserDownLoadDetailLog.Memo, Type.GetType("System.String"));
foreach (clsQxUserDownLoadDetailLogEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxUserDownLoadDetailLog.mId] = objInFor[conQxUserDownLoadDetailLog.mId];
objDR[conQxUserDownLoadDetailLog.UserDownLoadLogId] = objInFor[conQxUserDownLoadDetailLog.UserDownLoadLogId];
objDR[conQxUserDownLoadDetailLog.FileName] = objInFor[conQxUserDownLoadDetailLog.FileName];
objDR[conQxUserDownLoadDetailLog.Version] = objInFor[conQxUserDownLoadDetailLog.Version];
objDR[conQxUserDownLoadDetailLog.IsSuccess] = objInFor[conQxUserDownLoadDetailLog.IsSuccess];
objDR[conQxUserDownLoadDetailLog.LogInfo] = objInFor[conQxUserDownLoadDetailLog.LogInfo];
objDR[conQxUserDownLoadDetailLog.Memo] = objInFor[conQxUserDownLoadDetailLog.Memo];
