 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxUserLoginNameEN_Sim
 表名:QxUserLoginName
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:38:23
 生成者:潘以锋
...
public class clsQxUserLoginNameEN_Sim 
{
//以下是属性变量

private string mstrUserLoginName;    //用户登录名
private string mstrUserId;    //用户ID
private string mstrUpdUserId;    //修改用户Id
private string mstrUpdDate;    //修改日期
private string mstrUpdTime;    //修改时间
