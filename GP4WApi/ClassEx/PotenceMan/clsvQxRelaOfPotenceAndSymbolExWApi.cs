 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxRelaOfPotenceAndSymbolExWApi
 表名:vQxRelaOfPotenceAndSymbol(00140049)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:24:03
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsvQxRelaOfPotenceAndSymbolExWApi
{
private static readonly string mstrApiControllerName = "vQxRelaOfPotenceAndSymbolExApi";
 /// <summary>
