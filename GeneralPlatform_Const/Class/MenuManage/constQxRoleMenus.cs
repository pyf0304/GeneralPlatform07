...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constQxRoleMenus
{
public const string CurrTabName_S = "QxRoleMenus"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"mId", "RoleId", "QxPrjId", "MenuId", "UpdDate", "UpdUserId", "Memo"};
//以下是属性变量
