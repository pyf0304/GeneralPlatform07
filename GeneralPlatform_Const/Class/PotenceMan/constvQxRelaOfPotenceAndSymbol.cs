 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constvQxRelaOfPotenceAndSymbol
 表名:vQxRelaOfPotenceAndSymbol
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:39:56
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxRelaOfPotenceAndSymbol
{
public const string CurrTabName_S = "vQxRelaOfPotenceAndSymbol"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "RelaMid"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"RelaMid", "PotenceTypeName", "QxPrjId", "PotenceId", "PotenceName", "PrjName", "SymbolForProgramme", "SymbolName", "Memo", "PotenceTypeId", "UpdDate", "UpdUserId"};
//以下是属性变量
