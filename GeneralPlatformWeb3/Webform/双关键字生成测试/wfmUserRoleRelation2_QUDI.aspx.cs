...
namespace GeneralPlatform.Webform
{
    ...
    public partial class wfmUserRoleRelation2_QUDI : System.Web.UI.Page
    {
        ...
        protected void btnQuery_Click(object sender, System.EventArgs e)
        {
            ...
            this.gvUserRoleRelation2.PageIndex = 0;
            ///把表记录的内容显示在DATAGRID中
            BindGv_UserRoleRelation2();
        }
        /// <summary>
    ...
    public partial class wfmUserRoleRelation2_QUDI : System.Web.UI.Page
    {
        protected void ShowData(string strUserId, string strRoleId)
        {
            ...
            ///5、把该对象的所有属性显示在界面上，在这里显示在表控件中
            GetDataFromUserRoleRelation2Class(objUserRoleRelation2);
        }
        ...
        protected string CombineUserRoleRelation2Condion()
        {
            ...
            {
                strWhereCond += " And PrjId='" + this.ddlPrjId_q.SelectedValue + "'";
            }
        ...
        ///			 并显示在GridView中。
        /// </summary>
        protected void BindGv_UserRoleRelation2()
        {
            ///	操作步骤：(共5步)
            ///	1、组合界面条件串；
            ...
            ///	1、组合界面条件串；
            string strWhereCond = CombineUserRoleRelation2Condion();
            ///	2、根据条件串获取该表满足条件的DataTable；
        ...
        protected void GetDataFromUserRoleRelation2Class(clsUserRoleRelation2 pobjUserRoleRelation2)
        {
            wucUserRoleRelation21.UserId = pobjUserRoleRelation2.UserId;//    用户ID
            wucUserRoleRelation21.RoleId = pobjUserRoleRelation2.RoleId;//    角色Id
            wucUserRoleRelation21.PrjId = pobjUserRoleRelation2.PrjId;//    项目编号
            wucUserRoleRelation21.Memo = pobjUserRoleRelation2.Memo;//    备注
        }
        ///生成从界面层到逻辑层的数据传输函数代码
        /// <summary>
        ...
        protected void PutDataToUserRoleRelation2Class(clsUserRoleRelation2 pobjUserRoleRelation2)
        {
            pobjUserRoleRelation2.UserId = wucUserRoleRelation21.UserId;//    用户ID
            pobjUserRoleRelation2.RoleId = wucUserRoleRelation21.RoleId;//    角色Id
            pobjUserRoleRelation2.PrjId = wucUserRoleRelation21.PrjId;//    项目编号
            pobjUserRoleRelation2.Memo = wucUserRoleRelation21.Memo;//    备注
        }
        ...
        protected bool AddUserRoleRelation2RecordSave()
        {
            ...
            ///4、把值从界面层传到逻辑层或数据实体层
            PutDataToUserRoleRelation2Class(objUserRoleRelation2);		//把界面的值传到
            ///5、检查传进去的对象属性是否合法
            try
            {
