 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxViewPotenceWApi
 表名:QxViewPotence(00140018)
 * 版本:2023.08.19.1(服务器:WIN-SRV103-116)
 日期:2023/08/22 18:22:48
 生成者:pyf
 生成服务器IP:
 工程名称:统一平台(0014)
...
/// 静态类
/// </summary>
public static class  clsQxViewPotenceWApi_Static
{
...
try
{
objQxViewPotenceEN.sfUpdFldSetStr = objQxViewPotenceEN.getsfUpdFldSetStr();
clsQxViewPotenceWApi.CheckPropertyNew(objQxViewPotenceEN); 
bool bolResult = clsQxViewPotenceWApi.UpdateRecord(objQxViewPotenceEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsQxViewPotenceEN objQxViewPotenceEN)
{
//检测记录是否存在
...
{
clsQxViewPotenceWApi.CheckPropertyNew(objQxViewPotenceEN); 
bool bolResult = clsQxViewPotenceWApi.AddNewRecord(objQxViewPotenceEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxViewPotenceWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
{
clsQxViewPotenceWApi.CheckPropertyNew(objQxViewPotenceEN); 
bool bolResult = clsQxViewPotenceWApi.UpdateWithCondition(objQxViewPotenceEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxViewPotenceWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxViewPotenceWApi
{
private static readonly string mstrApiControllerName = "QxViewPotenceApi";
...
clsQxViewPotenceEN objQxViewPotenceEN;
...
objQxViewPotenceEN = JsonConvert.DeserializeObject<clsQxViewPotenceEN>(strJson);
return objQxViewPotenceEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxViewPotenceEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsQxViewPotenceEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxViewPotenceEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxViewPotenceEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsQxViewPotenceEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxViewPotenceEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxViewPotenceEN> arrObjLst; 
...
try
{
 clsQxViewPotenceEN objQxViewPotenceEN = clsQxViewPotenceWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxViewPotences(List<string> arrmId)
{
string strAction = "DelQxViewPotences";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelQxViewPotencesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxViewPotenceEN objQxViewPotenceEN)
{
...
public static string AddNewRecordWithReturnKey(clsQxViewPotenceEN objQxViewPotenceEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxViewPotenceEN objQxViewPotenceEN)
{
if (string.IsNullOrEmpty(objQxViewPotenceEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxViewPotenceEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxViewPotenceEN objQxViewPotenceEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxViewPotenceEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxViewPotenceEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxViewPotenceEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxViewPotenceEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxViewPotenceEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxViewPotenceEN objInFor in arrObj)
{
//Rows
...
if (clsQxViewPotenceWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxViewPotenceEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxViewPotenceWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsQxViewPotenceEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxViewPotence.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conQxViewPotence.ViewId, Type.GetType("System.String"));
objDT.Columns.Add(conQxViewPotence.QxPrjId, Type.GetType("System.String"));
objDT.Columns.Add(conQxViewPotence.PotenceId, Type.GetType("System.String"));
objDT.Columns.Add(conQxViewPotence.Level, Type.GetType("System.Int32"));
objDT.Columns.Add(conQxViewPotence.Memo, Type.GetType("System.String"));
foreach (clsQxViewPotenceEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxViewPotence.mId] = objInFor[conQxViewPotence.mId];
objDR[conQxViewPotence.ViewId] = objInFor[conQxViewPotence.ViewId];
objDR[conQxViewPotence.QxPrjId] = objInFor[conQxViewPotence.QxPrjId];
objDR[conQxViewPotence.PotenceId] = objInFor[conQxViewPotence.PotenceId];
objDR[conQxViewPotence.Level] = objInFor[conQxViewPotence.Level];
objDR[conQxViewPotence.Memo] = objInFor[conQxViewPotence.Memo];
