...
<%@ Page Language="c#" AutoEventWireup="True"
    Inherits="GeneralPlatform.Webform.wfmSetRoles4Users2" Codebehind="wfmSetRoles4Users2.aspx.cs" Theme="TaiZeTheme"  %>

<%@ Register src="../../tzTreeViewWuc/wucTreeView.ascx" tagname="wucTreeView" tagprefix="uc2" %>
        ...
        <table id="tabLayout" style="z-index: 105; left: 4px; position: absolute; top: 32px"
            ...
            <tr>
                <td rowspan="4" style="width: 5px" valign="top">
                    <uc2:wucTreeView ID="wucTreeView1" runat="server"  OnafterSelect_Tz="wucTreeView1_afterSelect_Tz"  />
