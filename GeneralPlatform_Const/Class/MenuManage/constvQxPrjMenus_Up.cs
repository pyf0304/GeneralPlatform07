...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPrjMenus_Up
{
public const string CurrTabName_S = "vQxPrjMenus_Up"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "MenuId_Up"; //当前表中的关键字名称,与该类相关的表中关键字名
...
//以下是属性变量
 ...
 /// </summary>
 public const string MenuId_Up = "MenuId_Up";    //MenuId_Up
