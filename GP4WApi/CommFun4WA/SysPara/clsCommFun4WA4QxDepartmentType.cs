 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsCommFun4WA4QxDepartmentType
 表名:QxDepartmentType(00140037)
 生成代码版本:2021.07.30.1
 生成日期:2021/07/30 00:50:34
 生成者:pyf
...
namespace GeneralPlatform4WApi
{
 ...
 /// </summary>
public class clsCommFun4WA4QxDepartmentType : clsCommFun4BL
{
...
clsQxDepartmentTypeWApi.ReFreshThisCache();
}
}
}