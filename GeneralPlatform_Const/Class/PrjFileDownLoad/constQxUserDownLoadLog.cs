 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constQxUserDownLoadLog
 表名:QxUserDownLoadLog
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:38:08
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constQxUserDownLoadLog
{
public const string CurrTabName_S = "QxUserDownLoadLog"; //当前表名,与该类相关的表名
