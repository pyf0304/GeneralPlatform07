...
{
throw new Exception(string.Format("(errid:Data000007)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSet)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 ...
 objDS = objSQL.GetDataSet(strSQL, "QxUserRoleRelation4Synch");
 return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000008)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSetByCondBySP)", objException.Message));
}
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDS = objSQL.ExecSPReturnDS("QxUserRoleRelation4Synch_SelectByCond",values, "QxUserRoleRelation4Synch");
return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000009)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSet_Top)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
public System.Data.DataSet GetDataSetByRange(string strCondition, string strOrderBy, int intMinNum, int intMaxNum)
{
     if (intMinNum <=  0)
 {
 throw new Exception(string.Format("在输入范围的最小值{0}非法,应该不小于0,请检查!(clsQxUserRoleRelation4SynchDA: GetQxUserRoleRelation4SynchByRange)", intMinNum));
 }
 if (intMaxNum > 6553005)
 {
 throw new Exception(string.Format("在输入范围的最大值{0}非法,应该不大于6553005(可以用其他条件来限制记录的条数),请检查!(clsQxUserRoleRelation4SynchDA: GetQxUserRoleRelation4SynchByRange)", intMaxNum));
 }
 if (intMaxNum < intMinNum)
 {
 throw new Exception(string.Format("在输入范围的最大值[{0}]不能小于最小值[{1}],非法,请检查!(clsQxUserRoleRelation4SynchDA: GetQxUserRoleRelation4SynchByRange)", intMaxNum, intMinNum));
 }
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000010)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSetByRange)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 objSQL = clsQxUserRoleRelation4SynchDA.GetSpecSQLObj();
 strSQL = string.Format("Select top {1} * from QxUserRoleRelation4Synch a where {0} And a.mId not in (Select Top {2} mId From QxUserRoleRelation4Synch Where {0})", strCondition, intMaxNum - intMinNum + 1, intMinNum - 1);
 objDS = objSQL.GetDataSet(strSQL, "QxUserRoleRelation4Synch");
return objDS;
}
...
{
throw new Exception(string.Format("(errid:Data000066)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSet)", objException.Message));
}
string strSQL; 
System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000067)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSet)ByRange", objException.Message));
}
try
 {
 if (bolIsCheckSQLAttack  ==  true)
...
{
throw new Exception(string.Format("(errid:Data000067)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataSetByRange)", objException.Message));
}
string strSQL; 
 System.Data.DataSet objDS; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000020)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTable)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000077)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTable)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000023)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTable_Top)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000026)在分页查询中输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTableByPager)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000027)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 ...
 {
 strSQL = string.Format("Select top {1} * from QxUserRoleRelation4Synch a where {0} And a.mId not in (Select Top {2} mId From QxUserRoleRelation4Synch Where {0} order by {3}) order by {3}", strCondition, intMaxNum - intMinNum + 1, intMinNum - 1, strOrderBy);
 }
objDT = objSQL.GetDataTable(strSQL);
return objDT;
}
...
{
throw new Exception(string.Format("(errid:Data000070)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000071)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTableByRange)", objException.Message));
}
string strSQL; 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("(errid:Data000030)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA: GetDataTableByCondBySP)", objException.Message));
}
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDT = objSQL.ExecSpReturnDT("QxUserRoleRelation4Synch_SelectByCond",values);
return objDT;
}
...
try
{
objQxUserRoleRelation4SynchEN.mId = TransNullToInt(objRow[conQxUserRoleRelation4Synch.mId].ToString().Trim()); //流水号
...
return arrObjLst;
 ...
 /// <param name = "strCondition">给定条件</param>
 /// <returns>返回对象列表</returns>
public List<clsQxUserRoleRelation4SynchEN> GetObjLstBySP(string strCondition)
{
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000038)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA:GetObjLstBySP)", objException.Message));
}
List<clsQxUserRoleRelation4SynchEN> arrObjLst = new List<clsQxUserRoleRelation4SynchEN>(); 
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
...
{
throw new Exception(string.Format("根据条件获取对象列表时,发生:{0},请检查!(clsQxUserRoleRelation4SynchDA: GetObjLstBySP)", objException.Message));
}
objQxUserRoleRelation4SynchEN.ClearUpdateState();//清除修改状态,即清除脏字段信息
	arrObjLst.Add(objQxUserRoleRelation4SynchEN);
	}
...
try
{
 objQxUserRoleRelation4SynchEN.mId = TransNullToInt(objDT.Rows[0][conQxUserRoleRelation4Synch.mId].ToString().Trim()); //流水号(字段类型:bigint,字段长度:8,是否可空:False)
 objQxUserRoleRelation4SynchEN.IpAddress = objDT.Rows[0][conQxUserRoleRelation4Synch.IpAddress].ToString().Trim(); //IP地址(字段类型:varchar,字段长度:23,是否可空:True)
 objQxUserRoleRelation4SynchEN.UserId = objDT.Rows[0][conQxUserRoleRelation4Synch.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:False)
 ...
 objQxUserRoleRelation4SynchEN.QxPrjId = objDT.Rows[0][conQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(); //项目Id(字段类型:char,字段长度:4,是否可空:False)
 objQxUserRoleRelation4SynchEN.UpdDate = objDT.Rows[0][conQxUserRoleRelation4Synch.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:False)
 objQxUserRoleRelation4SynchEN.UpdUser = objDT.Rows[0][conQxUserRoleRelation4Synch.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
...
try
{
 objQxUserRoleRelation4SynchEN.mId = Int32.Parse(objRow[conQxUserRoleRelation4Synch.mId].ToString().Trim()); //流水号(字段类型:bigint,字段长度:8,是否可空:False)
 objQxUserRoleRelation4SynchEN.IpAddress = objRow[conQxUserRoleRelation4Synch.IpAddress].ToString().Trim(); //IP地址(字段类型:varchar,字段长度:23,是否可空:True)
 objQxUserRoleRelation4SynchEN.UserId = objRow[conQxUserRoleRelation4Synch.UserId].ToString().Trim(); //用户ID(字段类型:varchar,字段长度:18,是否可空:False)
 ...
 objQxUserRoleRelation4SynchEN.QxPrjId = objRow[conQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(); //项目Id(字段类型:char,字段长度:4,是否可空:False)
 objQxUserRoleRelation4SynchEN.UpdDate = objRow[conQxUserRoleRelation4Synch.UpdDate] == DBNull.Value ? null : objRow[conQxUserRoleRelation4Synch.UpdDate].ToString().Trim(); //修改日期(字段类型:varchar,字段长度:20,是否可空:False)
 objQxUserRoleRelation4SynchEN.UpdUser = objRow[conQxUserRoleRelation4Synch.UpdUser] == DBNull.Value ? null : objRow[conQxUserRoleRelation4Synch.UpdUser].ToString().Trim(); //修改用户(字段类型:varchar,字段长度:20,是否可空:True)
...
return objQxUserRoleRelation4SynchEN;
 ...
 /// <param name = "objQxUserRoleRelation4SynchEN">需要添加到数据库中的对象</param>
 /// <returns>是否成功</returns>
public bool GetQxUserRoleRelation4SynchOneBySP(clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN)
{
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
...
//			 gobjSQL.SPConfigXMLFile = "..\\Parameter.xml"
 ArrayList values = new ArrayList()
{
 objQxUserRoleRelation4SynchEN.mId
};
 objDT = objSQL.ExecSpReturnDT("QxUserRoleRelation4Synch_SelectOne",values);
if (objDT.Rows.Count  ==  0)
{
return false;
}
...
try
{
	clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN = new clsQxUserRoleRelation4SynchEN()
{
mId = TransNullToInt(objRow[conQxUserRoleRelation4Synch.mId].ToString().Trim()), //流水号
...
QxPrjId = objRow[conQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(), //项目Id
...
UpdUser = objRow[conQxUserRoleRelation4Synch.UpdUser] == DBNull.Value ? null : objRow[conQxUserRoleRelation4Synch.UpdUser].ToString().Trim(), //修改用户
...
throw new Exception(string.Format("在根据条件获取第一个对象时,发生:{0},请检查!(clsQxUserRoleRelation4SynchDA: GetFirstObj)", objException.Message));
 ...
 /// <param name = "strCondition">给定条件</param>
 /// <returns>返回满足条件的第一个对象</returns>
public clsQxUserRoleRelation4SynchEN GetFirstObjBySP(string strCondition)
{
try
{
 clsCheckSql.CheckStrSQL_Weak(strCondition);
...
{
throw new Exception(string.Format("(errid:Data000040)在输入条件中含有{0},请检查!(clsQxUserRoleRelation4SynchDA:GetFirstObjBySP)", objException.Message));
}
System.Data.DataTable objDT; 
 clsSpecSQLforSql objSQL;
 //获取连接对象
 ...
 ArrayList values = new ArrayList()
{
 ...
 objDT = objSQL.ExecSpReturnDT("QxUserRoleRelation4Synch_SelectTop1ByCond",values);
if (objDT.Rows.Count  ==  0)
{
return null;
}
...
ArrayList arrReturn = objSQL.ExecSpWithOutPut("QxUserRoleRelation4Synch_IsExist", values);
...
objRow[conQxUserRoleRelation4Synch.QxPrjId] = objQxUserRoleRelation4SynchEN.QxPrjId; //项目Id
...
objRow[conQxUserRoleRelation4Synch.UpdDate] = objQxUserRoleRelation4SynchEN.UpdDate; //修改日期
 ...
 if (objQxUserRoleRelation4SynchEN.UpdUser !=  "")
 {
objRow[conQxUserRoleRelation4Synch.UpdUser] = objQxUserRoleRelation4SynchEN.UpdUser; //修改用户
 }
...
StringBuilder strSQL = new StringBuilder();
 ...
 if (objQxUserRoleRelation4SynchEN.RoleId  ==  "")
 {
 objQxUserRoleRelation4SynchEN.RoleId = null;
 }
 ...
 if (objQxUserRoleRelation4SynchEN.QxPrjId  ==  "")
 {
 objQxUserRoleRelation4SynchEN.QxPrjId = null;
 }
 ...
 {
 arrFieldListForInsert.Add(conQxUserRoleRelation4Synch.UpdUser);
 var strUpdUser = objQxUserRoleRelation4SynchEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
...
return objSQL.ExecSql(strSQL.ToString(), objSqlConnection, objSqlTransaction);
 ...
 /// <param name = "objQxUserRoleRelation4SynchEN">需要添加到数据库中的对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public bool AddnewQxUserRoleRelation4SynchBySP(clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN)
{
//通过存储过程来
//直接使用
 objQxUserRoleRelation4SynchEN.UpdDate = clsDateTime.getTodayDateTimeStr(1);
...
ArrayList values = new ArrayList()
{
 objQxUserRoleRelation4SynchEN.IpAddress,
 objQxUserRoleRelation4SynchEN.UserId,
 objQxUserRoleRelation4SynchEN.RoleId,
 objQxUserRoleRelation4SynchEN.QxPrjId,
 objQxUserRoleRelation4SynchEN.UpdDate,
 objQxUserRoleRelation4SynchEN.UpdUser,
objQxUserRoleRelation4SynchEN.Memo
};
 objSQL.ExecSP("QxUserRoleRelation4Synch_Add",values);
return true;
}
...
objRow[conQxUserRoleRelation4Synch.QxPrjId] = oRow[conQxUserRoleRelation4Synch.QxPrjId].ToString().Trim(); //项目Id
objRow[conQxUserRoleRelation4Synch.UpdDate] = oRow[conQxUserRoleRelation4Synch.UpdDate].ToString().Trim(); //修改日期
objRow[conQxUserRoleRelation4Synch.UpdUser] = oRow[conQxUserRoleRelation4Synch.UpdUser].ToString().Trim(); //修改用户
...
objRow[conQxUserRoleRelation4Synch.UpdDate] = objQxUserRoleRelation4SynchEN.UpdDate; //修改日期
 ...
 if (objQxUserRoleRelation4SynchEN.IsUpdated(conQxUserRoleRelation4Synch.UpdUser))
 {
objRow[conQxUserRoleRelation4Synch.UpdUser] = objQxUserRoleRelation4SynchEN.UpdUser; //修改用户
 }
...
return true;
 ...
 /// </summary>
 /// <returns>如果修改成功则返回TRUE,否则为FALSE</returns>
public bool UpdateBySP(clsQxUserRoleRelation4SynchEN objQxUserRoleRelation4SynchEN)
{
 objQxUserRoleRelation4SynchEN.UpdDate = clsDateTime.getTodayDateTimeStr(1);
 if (objQxUserRoleRelation4SynchEN._IsCheckProperty  ==  false)
 {
...
ArrayList values = new ArrayList()
{
 ...
 objSQL.ExecSP("QxUserRoleRelation4Synch_Update",values);
return true;
}
...
sbSQL.AppendFormat("Update QxUserRoleRelation4Synch Set ");
 ...
 {
 var strQxPrjId = objQxUserRoleRelation4SynchEN.QxPrjId.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strQxPrjId, conQxUserRoleRelation4Synch.QxPrjId); //项目Id
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation4Synch.QxPrjId); //项目Id
 }
 }
 ...
 {
 var strUpdUser = objQxUserRoleRelation4SynchEN.UpdUser.Replace("'", "''"); //转换值串中的单撇"'",使之成为双撇"''"
 sbSQL.AppendFormat("{1} = '{0}',", strUpdUser, conQxUserRoleRelation4Synch.UpdUser); //修改用户
 }
 else
 {
 sbSQL.AppendFormat("{0} = null,",conQxUserRoleRelation4Synch.UpdUser); //修改用户
 }
 }
...
//检查字段长度
clsCheckSql.CheckFieldLen(objQxUserRoleRelation4SynchEN.IpAddress, 23, conQxUserRoleRelation4Synch.IpAddress);
...
clsCheckSql.CheckFieldLen(objQxUserRoleRelation4SynchEN.UpdUser, 20, conQxUserRoleRelation4Synch.UpdUser);
clsCheckSql.CheckFieldLen(objQxUserRoleRelation4SynchEN.Memo, 1000, conQxUserRoleRelation4Synch.Memo);
//检查字段外键固定长度
clsCheckSql.CheckFieldForeignKey(objQxUserRoleRelation4SynchEN.RoleId, 8, conQxUserRoleRelation4Synch.RoleId);
clsCheckSql.CheckFieldForeignKey(objQxUserRoleRelation4SynchEN.QxPrjId, 4, conQxUserRoleRelation4Synch.QxPrjId);
...
clsCheckSql.CheckSqlInjection4Field(objQxUserRoleRelation4SynchEN.UpdUser, conQxUserRoleRelation4Synch.UpdUser);
