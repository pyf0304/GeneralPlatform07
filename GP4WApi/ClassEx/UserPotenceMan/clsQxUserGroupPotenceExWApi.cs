 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsQxUserGroupPotenceExWApi
 表名:QxUserGroupPotence(00140008)
 生成代码版本:2019.03.24.1
 生成日期:2019/03/24 09:23:39
 生成者:
...
namespace GP4WApi
{
 ...
 /// </summary>
public class clsQxUserGroupPotenceExWApi
{
private static readonly string mstrApiControllerName = "QxUserGroupPotenceExApi";
 /// <summary>
