...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public struct K_DepartmentId_vQxDepartmentInfo
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
{
public const string _CurrTabName_S = "vQxDepartmentInfo"; //当前表名,与该类相关的表名
...
/// </summary>
 ...
 _CurrTabName = "vQxDepartmentInfo";
