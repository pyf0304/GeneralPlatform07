...
namespace GeneralPlatform.Webform
{
    ...
    public partial class wucViewInfo : System.Web.UI.UserControl
	{
		...
		public string ViewTypeCode
		{
			get
			{
				return txtViewTypeCode.Text.Trim();
			}
			set
			{
		...
		public string MainTabName
		{
			get
			{
				return txtMainTabName.Text.Trim();
			}
			set
			{
				txtMainTabName.Text = value.ToString();
			}
		}
		...
		public string DetailTabName
		{
			get
			{
				return txtDetailTabName.Text.Trim();
			}
			set
			{
				txtDetailTabName.Text = value.ToString();
			}
		}
		...
		public string ModuleId
		{
			get
			{
				if (ddlModuleId.SelectedValue == "0")
					return "";
				return ddlModuleId.SelectedValue;
			}
			set
			{
				if (value == "")
				...
				{
					ddlModuleId.SelectedValue = value;
				}
			}
		}
...
//			txtViewDetail.Text = "";
		...
		public void SetMaxViewId()
		{
			if(getUserPrjId != "0")
			{
				this.txtViewId.Text = clsQxViewInfoBL.GetMaxStrIdByPrefix_S(getUserPrjId);
			}
			else
			{
				this.txtViewId.Text = "";
		...
		public void SetDdlPrjIdEnable(bool flag)
		{
		  this.ddlPrjId.Enabled = flag;

		}

		
		public void SetDdl_ModuleId(string strPrjId)
		{
