<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrjMenuSetExcelImport.aspx.cs" Inherits="GeneralPlatform.DataExcelImport.PrjMenuSetExcelImport"  %>
        ...
        <div>
            <table style="width: 100%">
                ...
                <tr id="stuGV" runat="server">
                    <td>
                        <asp:GridView ID="gvPrjMenuSet_Disp" runat="server" Style="z-index: 108;"
                            Width="100%"
                            AllowPaging="true"
                            BackColor="White"
                            BorderColor="#E7E7FF"
                            BorderStyle="None"
                            BorderWidth="1px"
                            CssClass="GridValue" OnPageIndexChanging="gvPrjMenuSet_Disp_PageIndexChanging">
                        </asp:GridView>
                    </td>
                </tr>
                        ...
                        <table id="tabLayout" style="width: 100%;" border="0" runat="server" class="msgtable">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table id="tabPrjMenuSetGridView" style="width: 100%" class="msgtable"
                                        runat="server">
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvPrjMenuSet" Style="z-index: 117;" runat="server"
                                                    Width="100%" AutoGenerateColumns="False"
                                                    PageSize="10" AllowPaging="true"
                                                    AllowSorting="true"
                                                    OnSorting="gvPrjMenuSet_Sorting"
                                                    OnPageIndexChanging="gvPrjMenuSet_PageIndexChanging"
                                                    OnRowDeleting="gvPrjMenuSet_RowDeleting"
                                                    BackColor="White"
                                                    BorderColor="#E7E7FF"
                                                    BorderStyle="None"
                                                    BorderWidth="1px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="MenuSetId" SortExpression="MenuSetId" HeaderText="菜单集Id"></asp:BoundField>
                                                        <asp:BoundField DataField="MenuSetName" SortExpression="MenuSetName" HeaderText="菜单集名"></asp:BoundField>
