...
namespace GeneralPlatform.Entity
{
 ...
 /// </summary>
public class K_RelaMid_QxRelaOfPotenceAndSymbol
{
...
public new const string _CurrTabName = "QxRelaOfPotenceAndSymbol"; //当前表名,与该类相关的表名
...
get
{
if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.RelaMid)
{
return mlngRelaMid;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.PotenceId)
{
return mstrPotenceId;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.SymbolForProgramme)
{
return mstrSymbolForProgramme;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.SymbolName)
{
return mstrSymbolName;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.Memo)
{
return mstrMemo;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.QxPrjId)
{
return mstrQxPrjId;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.UpdDate)
{
return mstrUpdDate;
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.UpdUserId)
{
...
mlngRelaMid = TransNullToInt(value.ToString());
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.RelaMid);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.PotenceId)
{
mstrPotenceId = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.PotenceId);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.SymbolForProgramme)
{
mstrSymbolForProgramme = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.SymbolForProgramme);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.SymbolName)
{
mstrSymbolName = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.SymbolName);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.Memo)
{
mstrMemo = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.Memo);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.QxPrjId)
{
mstrQxPrjId = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.QxPrjId);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.UpdDate)
{
mstrUpdDate = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.UpdDate);
}
else if (strAttributeName  ==  conQxRelaOfPotenceAndSymbol.UpdUserId)
{
mstrUpdUserId = value.ToString();
 AddUpdatedFld(conQxRelaOfPotenceAndSymbol.UpdUserId);
}
}
}
...
get
{
if (conQxRelaOfPotenceAndSymbol.RelaMid  ==  AttributeName[intIndex])
{
return mlngRelaMid;
}
else if (conQxRelaOfPotenceAndSymbol.PotenceId  ==  AttributeName[intIndex])
{
return mstrPotenceId;
}
else if (conQxRelaOfPotenceAndSymbol.SymbolForProgramme  ==  AttributeName[intIndex])
{
return mstrSymbolForProgramme;
}
else if (conQxRelaOfPotenceAndSymbol.SymbolName  ==  AttributeName[intIndex])
{
return mstrSymbolName;
}
else if (conQxRelaOfPotenceAndSymbol.Memo  ==  AttributeName[intIndex])
{
return mstrMemo;
}
else if (conQxRelaOfPotenceAndSymbol.QxPrjId  ==  AttributeName[intIndex])
{
return mstrQxPrjId;
}
else if (conQxRelaOfPotenceAndSymbol.UpdDate  ==  AttributeName[intIndex])
{
return mstrUpdDate;
}
else if (conQxRelaOfPotenceAndSymbol.UpdUserId  ==  AttributeName[intIndex])
{
return mstrUpdUserId;
}
return null;
...
{
public const string _CurrTabName = "QxRelaOfPotenceAndSymbol"; //当前表名,与该类相关的表名
