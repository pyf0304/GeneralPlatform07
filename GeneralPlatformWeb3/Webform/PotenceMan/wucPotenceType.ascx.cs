...
namespace GeneralPlatform.Webform
{
    ...
    /// <summary>
    ///		wucPotenceType 的摘要说明。
    /// </summary>
    public partial class wucPotenceType : System.Web.UI.UserControl
	{
		...
		public string PotenceTypeId
		{
			get
			{
				return txtPotenceTypeId.Text.Trim();
			}
			set
			{
				txtPotenceTypeId.Text = value.ToString();
			}
		}
		...
		public string PotenceTypeName
		{
			get
			{
				return txtPotenceTypeName.Text.Trim();
			}
			set
			{
				txtPotenceTypeName.Text = value.ToString();
			}
		}
		...
		{
			txtPotenceTypeId.ReadOnly = bolReadonly;
		}
		public void Clear()
		{
			txtPotenceTypeId.Text = "";
			txtPotenceTypeName.Text = "";
