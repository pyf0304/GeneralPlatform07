...
{
 /// <summary>
 /// 表vQxPrjMenus_Sub的关键字(MenuId_Sub)的类型定义. 以便检查类型以及操作方便.
 /// (AutoGCLib.EntityLayer4CSharp:GeneCode)
 /// </summary>
public struct K_MenuId_Sub_vQxPrjMenus_Sub
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
public K_MenuId_Sub_vQxPrjMenus_Sub(string strMenuId_Sub)
{
if (IsValid(strMenuId_Sub)) Value = strMenuId_Sub;
else
{
Value = null;
}
}
private static bool IsValid(string strMenuId_Sub)
{
if (string.IsNullOrEmpty(strMenuId_Sub) == true) return false;
if (strMenuId_Sub.Length != 8) return false;
return true;
}
/// <summary>
...
/// <param name="value">原类型表关键字</param>
 /// <returns>返回:[K_MenuId_Sub_vQxPrjMenus_Sub]类型的对象</returns>
public static implicit operator K_MenuId_Sub_vQxPrjMenus_Sub(string value)
{
return new K_MenuId_Sub_vQxPrjMenus_Sub(value);
}
}
 /// <summary>
...
{
public const string _CurrTabName_S = "vQxPrjMenus_Sub"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "MenuId_Sub"; //当前表中的关键字名称,与该类相关的表中关键字名
protected const int mintAttributeCount = 20;
public static string[] AttributeName = new string[] {"MenuId_Sub", "MenuName", "QxPrjId", "PrjName", "UpMenuId", "LinkFile", "qsParameters", "ImgFile", "OrderNum", "IsLeafNode", "MenuSetId", "MenuSetName", "MenuTitle", "PageDispModeId", "PageDispModeName", "InUse", "UpdDate", "UpdUserId", "Memo", "MenuControlName"};
//以下是属性变量

protected string mstrMenuId_Sub;    //MenuId_Sub
...
protected string mstrMenuControlName;    //MenuControlName
 ...
 /// </summary>
 public const string con_MenuId_Sub = "MenuId_Sub";    //MenuId_Sub
...
/// </summary>
 ...
 _CurrTabName = "vQxPrjMenus_Sub";
 lstKeyFldNames.Add("MenuId_Sub");
 }
...
/// </summary>
/// <param name = "strMenuId_Sub">关键字:MenuId_Sub</param>
public clsvQxPrjMenus_SubEN(string strMenuId_Sub)
 {
strMenuId_Sub = strMenuId_Sub.Replace("'", "''");
if (strMenuId_Sub.Length > 8)
{
throw new Exception("在表:vQxPrjMenus_Sub中,关键字长度不正确!");
}
if (string.IsNullOrEmpty(strMenuId_Sub)  ==  true)
{
throw new Exception("在表:vQxPrjMenus_Sub中,关键字不能为空 或 null!");
}
try
{
clsCheckSql.CheckStrSQL_Weak(strMenuId_Sub);
}
...
this.mstrMenuId_Sub = strMenuId_Sub;
 SetInit();
 mbolIsCheckProperty = false;
 _CurrTabName = "vQxPrjMenus_Sub";
 lstKeyFldNames.Add("MenuId_Sub");
...
get
{
if (strAttributeName  ==  con_MenuId_Sub)
{
...
if (strAttributeName  ==  con_MenuId_Sub)
{
mstrMenuId_Sub = value.ToString();
 AddUpdatedFld(con_MenuId_Sub);
}
else if (strAttributeName  ==  con_MenuName)
{
...
get
{
if (con_MenuId_Sub  ==  AttributeName[intIndex])
{
return mstrMenuId_Sub;
}
