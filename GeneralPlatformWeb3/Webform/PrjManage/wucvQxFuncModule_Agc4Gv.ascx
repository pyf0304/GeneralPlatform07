<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="wucvQxFuncModule_Agc4Gv.ascx.cs" Inherits="GeneralPlatform.Webform.wucvQxFuncModule_Agc4Gv" %>
...
<div id="divList" class="div_List"
    runat="server">
    <asp:GridView ID="gvQxFuncModule_Agc" Style="z-index: 101;" runat="server"
        Width="100%" AutoGenerateColumns="False"
        PageSize="10" AllowPaging="true"
        AllowSorting="true"
        OnSorting="gvQxFuncModule_Agc_Sorting"
        OnPageIndexChanging="gvQxFuncModule_Agc_PageIndexChanging"
        OnRowCreated="gvQxFuncModule_Agc_RowCreated"
        OnRowCommand="gvQxFuncModule_Agc_RowCommand"
        OnRowDeleting="gvQxFuncModule_Agc_RowDeleting"
        OnRowUpdating="gvQxFuncModule_Agc_RowUpdating"
        BackColor="White"
        BorderColor="#E7E7FF"
        BorderStyle="None"
        BorderWidth="1px"
        ...
        <Columns>
            <asp:TemplateField HeaderText="全选">
                ...
                <ItemTemplate>
                    <a name="A_QxFuncModule_Agc<%# Eval("FuncModuleAgcId").ToString().Trim() %>"></a>
                    <asp:CheckBox ID="chkCheckRec" runat="server"></asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="OrderNum" SortExpression="OrderNum" HeaderText="排序号"></asp:BoundField>
            <asp:BoundField DataField="FuncModuleAgcId" SortExpression="FuncModuleAgcId" HeaderText="模块Id"></asp:BoundField>
