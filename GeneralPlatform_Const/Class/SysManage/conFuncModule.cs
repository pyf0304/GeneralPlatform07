...
{
public const string _CurrTabName_S = "FuncModule"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "FuncModuleId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"FuncModuleId", "FuncModuleName", "FuncModuleName_Sim", "FuncModuleEnName", "OrderNum", "PrjId", "UseStateId", "UpdDate", "UpdUser", "Memo"};
//以下是属性变量
