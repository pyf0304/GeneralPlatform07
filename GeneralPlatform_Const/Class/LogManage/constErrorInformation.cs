 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:constErrorInformation
 表名:ErrorInformation
 生成代码版本:2018.04.19.1
 生成日期:2018/04/20 12:37:26
 生成者:潘以锋
...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constErrorInformation
{
public const string CurrTabName_S = "ErrorInformation"; //当前表名,与该类相关的表名
