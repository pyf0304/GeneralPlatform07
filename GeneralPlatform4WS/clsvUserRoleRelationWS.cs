...
namespace GeneralPlatform4WS
{
    ...
    public class clsvQxUserRoleRelationWS
    {
        ...
        public static int BindLv_vUserRoleRelation(System.Windows.Forms.ListView lvvUserRoleRelation, string strWhereCond)
        {
            ...
            List<clsvQxUserRoleRelationEN> arrvUserRoleRelationObjList;
            //	2、根据条件串获取该表满足条件的DataTable；
            ...
            //	4、设置ListView的Item信息。即把所有记录显示在ListView中
            foreach (clsvQxUserRoleRelationEN objvUserRoleRelationEN in arrvUserRoleRelationObjList)
            {
                ...
                lvivUserRoleRelation.SubItems.Add(objvUserRoleRelationEN.QxPrjId);
        ...
        public static DataTable GetDataTable_vUserRoleRelationWs(string strWhereCond)
        {
            ...
            {
                throw new Exception("获取表:vUserRoleRelation 数据出错！\r\n(clsvQxUserRoleRelationWS:GetDataTable_vUserRoleRelationWs)" + objException.Message);
            }
        }
        ...
        public static DataTable GetDataTable_vUserRoleRelationByRangeWs(string strWhereCond, long lngMinNum, long lngMaxNum)
        {
            ...
            {
                throw new Exception("获取表:vUserRoleRelation 数据出错！\r\n(clsvQxUserRoleRelationWS:GetDataTable_vUserRoleRelationByRangeWs)" + objException.Message);
            }
        }
        ...
        public static bool GetvUserRoleRelationWs(ref clsvQxUserRoleRelationEN objvUserRoleRelationEN)
        {
            vUserRoleRelationServiceSoapClient objvUserRoleRelationService = GetvUserRoleRelationServiceSoapClient();
        ...
        public static List<clsvQxUserRoleRelationEN> GetvUserRoleRelationObjList(string strCondition)
        {
            List<clsvQxUserRoleRelationEN> arrObjList = new List<clsvQxUserRoleRelationEN>();
            ...
            {
                clsvQxUserRoleRelationEN objvUserRoleRelationEN = new clsvQxUserRoleRelationEN();
                ...
                objvUserRoleRelationEN.QxPrjId = objRow[clsQxProjectsEN.con_QxPrjId].ToString().Trim(); //项目Id
        ...
        public static List<clsvQxUserRoleRelationEN> GetvUserRoleRelationObjListByRange(string strCondition, long lngMinNum, long lngMaxNum)
        {
            List<clsvQxUserRoleRelationEN> arrObjList = new List<clsvQxUserRoleRelationEN>();
            System.Data.DataTable objDT = null;
