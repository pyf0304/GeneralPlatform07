...
/// 静态类
/// </summary>
public static class  clsUserDefaValueWApi_Static
{
...
try
{
objUserDefaValueEN.sfUpdFldSetStr = objUserDefaValueEN.getsfUpdFldSetStr();
clsUserDefaValueWApi.CheckPropertyNew(objUserDefaValueEN); 
bool bolResult = clsUserDefaValueWApi.UpdateRecord(objUserDefaValueEN);
...
throw new Exception(strMsg); 
 ...
 /// <returns></returns>
public static string GetUniConditionStr(this clsUserDefaValueEN objUserDefaValueEN)
{
//检测记录是否存在
...
{
clsUserDefaValueWApi.CheckPropertyNew(objUserDefaValueEN); 
bool bolResult = clsUserDefaValueWApi.AddNewRecord(objUserDefaValueEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserDefaValueWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
{
clsUserDefaValueWApi.CheckPropertyNew(objUserDefaValueEN); 
bool bolResult = clsUserDefaValueWApi.UpdateWithCondition(objUserDefaValueEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsUserDefaValueWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsUserDefaValueWApi
{
private static readonly string mstrApiControllerName = "UserDefaValueApi";
...
if (!Object.Equals(null, objUserDefaValueEN.UpdDate) && GetStrLen(objUserDefaValueEN.UpdDate) > 20)
{
...
clsUserDefaValueEN objUserDefaValueEN;
...
objUserDefaValueEN = JsonConvert.DeserializeObject<clsUserDefaValueEN>(strJson);
return objUserDefaValueEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsUserDefaValueEN GetFirstObj(string strWhereCond)
{
...
{
 List<clsUserDefaValueEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsUserDefaValueEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsUserDefaValueEN> GetObjLstByMIdLst(List<long> arrMId)
{
 List<clsUserDefaValueEN> arrObjLst; 
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsUserDefaValueEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsUserDefaValueEN> arrObjLst; 
...
try
{
 clsUserDefaValueEN objUserDefaValueEN = clsUserDefaValueWApi.GetObjBymId(lngmId);
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelUserDefaValues(List<string> arrmId)
{
string strAction = "DelUserDefaValues";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrmId);
...
{
string strAction = "DelUserDefaValuesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsUserDefaValueEN objUserDefaValueEN)
{
...
public static string AddNewRecordWithReturnKey(clsUserDefaValueEN objUserDefaValueEN)
{
string strAction = "AddNewRecord";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsUserDefaValueEN objUserDefaValueEN)
{
if (string.IsNullOrEmpty(objUserDefaValueEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objUserDefaValueEN.mId, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsUserDefaValueEN objUserDefaValueEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objUserDefaValueEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsUserDefaValueEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsUserDefaValueEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsUserDefaValueEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsUserDefaValueEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsUserDefaValueEN objInFor in arrObj)
{
//Rows
...
if (clsUserDefaValueWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsUserDefaValueEN._CurrTabName);
CacheHelper.Remove(strKey);
clsUserDefaValueWApi.objCommFun4WApi.ReFreshCache();
}
}
...
public static DataTable GetDataTableByObjLst(List<clsUserDefaValueEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conUserDefaValue.mId, Type.GetType("System.Int64"));
objDT.Columns.Add(conUserDefaValue.DefaValName, Type.GetType("System.String"));
objDT.Columns.Add(conUserDefaValue.UserId, Type.GetType("System.String"));
objDT.Columns.Add(conUserDefaValue.UserDefaValue, Type.GetType("System.String"));
objDT.Columns.Add(conUserDefaValue.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conUserDefaValue.UpdUser, Type.GetType("System.String"));
objDT.Columns.Add(conUserDefaValue.Memo, Type.GetType("System.String"));
foreach (clsUserDefaValueEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conUserDefaValue.mId] = objInFor[conUserDefaValue.mId];
objDR[conUserDefaValue.DefaValName] = objInFor[conUserDefaValue.DefaValName];
objDR[conUserDefaValue.UserId] = objInFor[conUserDefaValue.UserId];
objDR[conUserDefaValue.UserDefaValue] = objInFor[conUserDefaValue.UserDefaValue];
objDR[conUserDefaValue.UpdDate] = objInFor[conUserDefaValue.UpdDate];
objDR[conUserDefaValue.UpdUser] = objInFor[conUserDefaValue.UpdUser];
objDR[conUserDefaValue.Memo] = objInFor[conUserDefaValue.Memo];
