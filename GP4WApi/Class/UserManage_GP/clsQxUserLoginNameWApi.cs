...
/// 静态类
/// </summary>
public static class  clsQxUserLoginNameWApi_Static
{
...
try
{
objQxUserLoginNameEN.sfUpdFldSetStr = objQxUserLoginNameEN.getsfUpdFldSetStr();
clsQxUserLoginNameWApi.CheckPropertyNew(objQxUserLoginNameEN); 
bool bolResult = clsQxUserLoginNameWApi.UpdateRecord(objQxUserLoginNameEN);
...
clsStackTrace.GetCurrClassFunction()); 
 ...
 if (clsQxUserLoginNameWApi.IsExist(objQxUserLoginNameEN.UserLoginName) == true)
 {
...
{
clsQxUserLoginNameWApi.CheckPropertyNew(objQxUserLoginNameEN); 
bool bolResult = clsQxUserLoginNameWApi.AddNewRecord(objQxUserLoginNameEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserLoginNameWApi.ReFreshCache();
return bolResult;
}
catch (Exception objException)
{
...
throw new Exception(strMsg); 
 ...
 /// <param name = "objQxUserLoginNameEN">需要添加的实体对象</param>
 /// <returns>如果插入成功则返回TRUE,否则为FALSE</returns>
public static string AddNewRecordWithMaxId(this clsQxUserLoginNameEN objQxUserLoginNameEN)
{
try
{
clsQxUserLoginNameWApi.CheckPropertyNew(objQxUserLoginNameEN); 
string strUserLoginName = clsQxUserLoginNameWApi.AddNewRecordWithMaxId(objQxUserLoginNameEN);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserLoginNameWApi.ReFreshCache();
...
{
clsQxUserLoginNameWApi.CheckPropertyNew(objQxUserLoginNameEN); 
bool bolResult = clsQxUserLoginNameWApi.UpdateWithCondition(objQxUserLoginNameEN, strWhereCond);
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
clsQxUserLoginNameWApi.ReFreshCache();
return bolResult;
}
...
throw new Exception(strMsg); 
 ...
 /// </summary>
public class clsQxUserLoginNameWApi
{
private static readonly string mstrApiControllerName = "QxUserLoginNameApi";
...
if (!Object.Equals(null, objQxUserLoginNameEN.UpdUserId) && GetStrLen(objQxUserLoginNameEN.UpdUserId) > 20)
{
 throw new Exception("字段[修改用户Id]的长度不能超过20!");
}
if (!Object.Equals(null, objQxUserLoginNameEN.UpdDate) && GetStrLen(objQxUserLoginNameEN.UpdDate) > 20)
{
...
clsQxUserLoginNameEN objQxUserLoginNameEN;
...
objQxUserLoginNameEN = JsonConvert.DeserializeObject<clsQxUserLoginNameEN>(strJson);
return objQxUserLoginNameEN;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static clsQxUserLoginNameEN GetFirstObj(string strWhereCond)
{
...
from objQxUserLoginNameEN in arrQxUserLoginNameObjLstCache
where objQxUserLoginNameEN.UserLoginName == strUserLoginName 
select objQxUserLoginNameEN;
if (arrQxUserLoginNameObjLst_Sel.Count() == 0)
{
   clsQxUserLoginNameEN obj = clsQxUserLoginNameWApi.GetObjByUserLoginName(strUserLoginName);
   if (obj != null)
 {
...
{
 List<clsQxUserLoginNameEN> arrObjLst; 
...
arrObjLst = JsonConvert.DeserializeObject<List<clsQxUserLoginNameEN>>(strJson);
return arrObjLst;
}
else
{
...
throw new Exception(strMsg);
 ...
 /// <returns>返回对象列表</returns>
public static List<clsQxUserLoginNameEN> GetObjLstByUserLoginNameLst(List<string> arrUserLoginName)
{
 List<clsQxUserLoginNameEN> arrObjLst; 
...
public static IEnumerable<clsQxUserLoginNameEN> GetObjLstByUserLoginNameLstCache(List<string> arrUserLoginName)
{
//初始化列表缓存
string strKey = string.Format("{0}", clsQxUserLoginNameEN._CurrTabName);
List<clsQxUserLoginNameEN> arrQxUserLoginNameObjLstCache = GetObjLstCache();
IEnumerable <clsQxUserLoginNameEN> arrQxUserLoginNameObjLst_Sel =
from objQxUserLoginNameEN in arrQxUserLoginNameObjLstCache
where arrUserLoginName.Contains(objQxUserLoginNameEN.UserLoginName)
select objQxUserLoginNameEN;
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "objPagerPara">分页获取记录的参数对象</param>
 /// <returns>返回JSON对象列表</returns>
public static List<clsQxUserLoginNameEN> GetObjLstByPagerCache(stuPagerPara objPagerPara)
{
 List<clsQxUserLoginNameEN> arrObjLst; 
...
try
{
 clsQxUserLoginNameEN objQxUserLoginNameEN = clsQxUserLoginNameWApi.GetObjByUserLoginName(strUserLoginName);
if (clsPubFun4WApi.Delete(mstrApiControllerName, strAction, strUserLoginName.ToString(), out string strResult, out string strErrMsg) == true)
{
JObject jobjReturn0 = JObject.Parse(strResult);
if ((int)jobjReturn0["errorId"] == 0)
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>实际删除记录的个数</returns>
public static int DelQxUserLoginNames(List<string> arrUserLoginName)
{
string strAction = "DelQxUserLoginNames";
Dictionary<string, string> dictParam = new Dictionary<string, string>();
try
{
string strJSON = clsJSON.GetJsonFromObjLst(arrUserLoginName);
...
{
string strAction = "DelQxUserLoginNamesByCond";
Dictionary<string, string> dictParam = new Dictionary<string, string>()
{
["strWhereCond"] = strWhereCond
};
...
public static bool AddNewRecord(clsQxUserLoginNameEN objQxUserLoginNameEN)
{
...
public static string AddNewRecordWithMaxId(clsQxUserLoginNameEN objQxUserLoginNameEN)
{
...
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
var strUserLoginName = (string)jobjReturn0["returnStr"];
return strUserLoginName;
}
else
{
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// </summary>
 /// <returns>是否成功?</returns>
public static bool UpdateRecord(clsQxUserLoginNameEN objQxUserLoginNameEN)
{
if (string.IsNullOrEmpty(objQxUserLoginNameEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
objQxUserLoginNameEN.UserLoginName, clsStackTrace.GetCurrClassFunction());
throw new Exception(strMsg);
}
...
clsPubFun4WApi.GetWebApiUrl(mstrApiControllerName, strAction));
 ...
 /// <param name = "strWhereCond">条件串</param>
 /// <returns>返回的第一条记录的关键字值</returns>
public static bool UpdateWithCondition(clsQxUserLoginNameEN objQxUserLoginNameEN, string strWhereCond)
{
if (string.IsNullOrEmpty(objQxUserLoginNameEN.sfUpdFldSetStr) == true)
{
string strMsg = string.Format("修改时,修改标志串为空,请联系管理员.对象关键字:{0}.(from {1}).",
...
public static DataTable ToDataTable(List<clsQxUserLoginNameEN> arrObj)
{
DataTable dataTable = new DataTable(); //实例化
DataTable result;
if (arrObj.Count == 0) return null;
if (clsQxUserLoginNameEN.AttributeName.Length == 0)
{
result = dataTable;
return result;
}
Type type = typeof(clsQxUserLoginNameEN);
PropertyInfo[] arrPropertyInfo = type.GetProperties();
try
{
//Columns
foreach (string strAttrName in clsQxUserLoginNameEN.AttributeName)
{
PropertyInfo proprety_Curr = arrPropertyInfo.Where(x => x.Name == strAttrName).First();
dataTable.Columns.Add(strAttrName, proprety_Curr.PropertyType);
}
foreach (clsQxUserLoginNameEN objInFor in arrObj)
{
//Rows
...
if (clsQxUserLoginNameWApi.objCommFun4WApi != null) 
{
// 静态的对象列表,用于清空相关缓存,针对记录较少,作为参数表可以使用
string strKey = string.Format("{0}", clsQxUserLoginNameEN._CurrTabName);
CacheHelper.Remove(strKey);
clsQxUserLoginNameWApi.objCommFun4WApi.ReFreshCache();
}
}
...
//初始化列表缓存
var strWhereCond = "";
var strKey = clsQxUserLoginNameEN._CurrTabName;
List<clsQxUserLoginNameEN> arrQxUserLoginNameObjLstCache = CacheHelper.GetCache(strKey, () => { return GetObjLst(strWhereCond); });
...
public static DataTable GetDataTableByObjLst(List<clsQxUserLoginNameEN> arrObjLst)
{
DataTable objDT = new DataTable();
objDT.Columns.Add(conQxUserLoginName.UserLoginName, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserLoginName.UserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserLoginName.UpdUserId, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserLoginName.UpdDate, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserLoginName.UpdTime, Type.GetType("System.String"));
objDT.Columns.Add(conQxUserLoginName.Memo, Type.GetType("System.String"));
foreach (clsQxUserLoginNameEN objInFor in arrObjLst)
{
DataRow objDR = objDT.NewRow();
objDR[conQxUserLoginName.UserLoginName] = objInFor[conQxUserLoginName.UserLoginName];
objDR[conQxUserLoginName.UserId] = objInFor[conQxUserLoginName.UserId];
objDR[conQxUserLoginName.UpdUserId] = objInFor[conQxUserLoginName.UpdUserId];
objDR[conQxUserLoginName.UpdDate] = objInFor[conQxUserLoginName.UpdDate];
objDR[conQxUserLoginName.UpdTime] = objInFor[conQxUserLoginName.UpdTime];
objDR[conQxUserLoginName.Memo] = objInFor[conQxUserLoginName.Memo];
