...
namespace GeneralPlatform.Const
{
 ...
 /// </summary>
public static class constvQxPotenceType
{
public const string CurrTabName_S = "vQxPotenceType"; //当前表名,与该类相关的表名
public const string CurrTabKeyFldName_S = "PotenceTypeId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"PotenceTypeId", "PotenceTypeName", "QxPrjId", "PrjName", "Memo", "UpdDate", "UpdUserId"};
//以下是属性变量
