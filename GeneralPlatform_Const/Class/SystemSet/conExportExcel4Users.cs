 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:conExportExcel4Users
 表名:ExportExcel4Users(00140066)
 生成代码版本:2021.07.30.1
 生成日期:2021/07/30 00:05:03
 生成者:pyf
...
{
public const string _CurrTabName_S = "ExportExcel4Users"; //当前表名,与该类相关的表名
public const string _CurrTabKeyFldName_S = "mId"; //当前表中的关键字名称,与该类相关的表中关键字名
public static string[] AttributeName = new string[] {"mId", "id_ExportExcel4Users", "FieldName", "FieldCnName", "IsExport", "OrderNum", "UpdDate", "UpdUserId", "Memo", "UserId", "ViewName"};
//以下是属性变量
