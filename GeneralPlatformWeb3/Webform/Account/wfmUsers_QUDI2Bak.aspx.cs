...
namespace GeneralPlatform.Webform
{
    ...
    /// </summary>
    public partial class wfmUsers_QUDI2Bak : System.Web.UI.Page
    {
        ...
        private void BindDg_QxUsers()
        {
            ...
            {
                this.divUsersJumpPage.Visible = true;
            }
            else
            {
                this.divUsersJumpPage.Visible = false;
            }
        ...
        protected void btnSynchTo_Click(object sender, EventArgs e)
        {
            ...
            string strCurrIp = clsCommonSession.IpAddress;
            try
            {
                //clsQxUsersBLEx.SynDataToOtherServer(strCurrPrjId, strServerId, strCurrIp);
            }
            catch (Exception objException)
            {
