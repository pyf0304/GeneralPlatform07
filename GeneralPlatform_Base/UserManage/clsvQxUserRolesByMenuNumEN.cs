 ...
 /*-- -- -- -- -- -- -- -- -- -- --
 类名:clsvQxUserRolesByMenuNumEN
 表名:vQxUserRolesByMenuNum(00140083)
 生成代码版本:2019.07.11.1
 生成日期:2019/07/12 09:58:15
 生成者:
...
{
 /// <summary>
 /// 表vQxUserRolesByMenuNum的关键字(RoleId)的类型定义. 以便检查类型以及操作方便.
 /// (AutoGCLib.EntityLayer4CSharp:GeneCode)
 /// </summary>
public struct K_RoleId_vQxUserRolesByMenuNum
{
/// <summary>
/// 关键字类型内面的值
/// </summary>
...
public K_RoleId_vQxUserRolesByMenuNum(string strRoleId)
{
...
/// <param name="value">原类型表关键字</param>
 /// <returns>返回:[K_RoleId_vQxUserRolesByMenuNum]类型的对象</returns>
public static implicit operator K_RoleId_vQxUserRolesByMenuNum(string value)
{
return new K_RoleId_vQxUserRolesByMenuNum(value);
}
}
 /// <summary>
...
public class clsvQxUserRolesByMenuNumEN : clsEntityBase2
{
public const string _CurrTabName_S = "vQxUserRolesByMenuNum"; //当前表名,与该类相关的表名
...
protected int mintMenuNum;    //MenuNum
 ...
 /// (AGC.BusinessLogicEx.clsPrjTabFldBLEx:DefPropertyNameConst)
 /// </summary>
 public const string con_MenuNum = "MenuNum";    //MenuNum

/// <summary>
/// 构造函数
 /// (AutoGCLib.clsGeneCodeBase:GenClassConstructor1)
/// </summary>
 public clsvQxUserRolesByMenuNumEN()
 {
 SetInit();
 mbolIsCheckProperty = false;
 _CurrTabName = "vQxUserRolesByMenuNum";
...
public clsvQxUserRolesByMenuNumEN(string strRoleId)
 {
strRoleId = strRoleId.Replace("'", "''");
if (strRoleId.Length > 8)
{
throw new Exception("在表:vQxUserRolesByMenuNum中,关键字长度不正确!");
}
if (string.IsNullOrEmpty(strRoleId)  ==  true)
{
throw new Exception("在表:vQxUserRolesByMenuNum中,关键字不能为空 或 null!");
}
try
{
...
else if (strAttributeName  ==  con_MenuNum)
{
return mintMenuNum;
}
return null;
...
else if (con_MenuNum  ==  AttributeName[intIndex])
{
return mintMenuNum;
}
return null;
