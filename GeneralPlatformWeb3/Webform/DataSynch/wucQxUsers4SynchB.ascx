...
<%@ Control Language = "C#" AutoEventWireup = "True" CodeBehind = "wucQxUsers4SynchB.ascx.cs" Inherits = "GeneralPlatform.Webform.wucQxUsers4SynchB" %>
            <link href="../../Content/bootstrap.min.css" rel="stylesheet" />
    <script src="../../Scripts/jquery-3.4.1.min.js" type="text/javascript"></script>
    <script src="../../Scripts/bootstrap.js" type="text/javascript"></script>
<link rel = "stylesheet" type = "text/css" href = "../../css/tz_base11.css"/>
<table id = "tabwucQxUsers4Synch" style = "width:600px; padding:1px;" border = "0">
<tr>
<td class = "NameTD">
